!(function () {
  ...
  var b = (function () {
    ...
    function o(t, e) {
      ...
      if (
        ...
        x(this, "transitionPrefix", void 0),
        x(this, "isPassiveEventsSupported", void 0),
        x(this, "transitionCapable", !1),
        x(this, "isTouchDevice", "ontouchstart" in window),
        x(
          this,
          "isAppleDevice",
          /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform)
        ),
        x(this, "initialLocationHash", void 0),
        x(this, "pushStateSupport", "pushState" in history),
        x(this, "isOpen", !1),
        x(this, "isAnimating", !1),
        x(this, "isClosing", !1),
        x(this, "isFadeIn", !1),
        x(this, "urlChangedOnce", !1),
        x(this, "hashReseted", !1),
        x(this, "historyHasChanges", !1),
        x(this, "historyUpdateTimeout", null),
        x(this, "currentImage", void 0),
        x(this, "eventNamespace", "simplelightbox"),
        x(this, "domNodes", {}),
        x(this, "loadedImages", []),
        x(this, "initialImageIndex", 0),
        x(this, "currentImageIndex", 0),
        x(this, "initialSelector", null),
        x(this, "globalScrollbarWidth", 0),
        x(this, "controlCoordinates", {
          swipeDiff: 0,
          swipeYDiff: 0,
          swipeStart: 0,
          swipeEnd: 0,
        ...
        },
        {
          ...
          value: function (t) {
            if (this.options.captionSelector.startsWith("+")) {
              var e = this.options.captionSelector
                  .replace(/^\+/, "")
                  .trimStart(),
              ...
              for (n.s(); !(o = n.n()).done; ) {
                ...
                try {
                  for (a.s(); !(i = a.n()).done; ) {
                    ...
                    r.namespaces &&
                      r.namespaces[s] &&
                      (r.removeEventListener(s.split(".")[0], r.namespaces[s]),
  ...
  ("use strict");
  (e = void 0 === d ? ("undefined" == typeof window ? v : window) : d),
    (o = function (t) {
      "use strict";
      ...
      var e,
        ...
        u = { Show: "Show", Ask: "Ask", Prompt: "Prompt" },
        p = {
        ...
        T = function (o, n, i, r) {
          ...
          if (
            ...
            var f = {};
            "object" == typeof i ? (f = i) : "object" == typeof r && (f = r),
              (e = k(!0, e, f));
          }
          ...
          if (
            ((u.id = c.wrapID),
            (u.style.width = e.width),
            (u.style.zIndex = e.zindex),
            (u.style.opacity = e.opacity),
            "center-center" === e.position
              ? ((u.style.left = e.distance),
                (u.style.top = e.distance),
                (u.style.right = e.distance),
                (u.style.bottom = e.distance),
                (u.style.margin = "auto"),
                u.classList.add("nx-flex-center-center"),
                (u.style.maxHeight =
            ...
            (p.id = c.overlayID),
              ...
              (p.style.zIndex = e.zindex - 1),
              (p.style.left = 0),
              (p.style.top = 0),
              (p.style.right = 0),
              (p.style.bottom = 0),
              (p.style.background = d.backOverlayColor || e.backOverlayColor),
              (p.className = e.cssAnimation ? "nx-with-animation" : ""),
              (p.style.animationDuration = e.cssAnimation
          ...
          (m.id = e.ID + "-" + R),
            ...
            (m.style.color = d.textColor),
            (m.style.background = d.background),
          ...
          if (x) {
            var b,
              ...
              N = function () {
                ...
                e && 0 >= u.childElementCount && e.classList.add("nx-remove"),
                  clearTimeout(b);
              },
              S = function () {
                if (
                  (x && null !== x.parentNode && x.parentNode.removeChild(x),
                  0 >= u.childElementCount && null !== u.parentNode)
                ) {
        ...
        B = function (e, n, i, r, a, l) {
          ...
          if (
            ...
            var w = {};
            "object" == typeof a ? (w = a) : "object" == typeof l && (w = l),
              (b = k(!0, o, {})),
              (o = k(!0, o, w));
          }
          ...
          (S.id = d.ID),
            ...
            o.rtl &&
              (S.setAttribute("dir", "rtl"), S.classList.add("nx-rtl-on")),
        ...
        M = function (e, o, i, r, a, l, c, f, d) {
          ...
          n || H.Confirm.init({});
          var m = k(!0, n, {});
          "object" != typeof d || Array.isArray(d) || (n = k(!0, n, d)),
            ...
            n.plainText && ((o = C(o)), (i = C(i)), (a = C(a)), (l = C(l))),
            n.plainText ||
          ...
          if (("string" == typeof o && 0 < o.length && (f = o), r)) {
            f =
              f.length > i.messageMaxLength
                ? C(f).toString().substring(0, i.messageMaxLength) + "..."
                : C(f).toString();
            var d,
              u,
              p = "";
            ...
            var y = parseInt((i.svgSize || "").replace(/[^0-9]/g, "")),
              b = t.innerWidth,
              w = y >= b ? b - 40 + "px" : y + "px",
              L =
                '<div style="width:' +
            ...
            (R.id = h.ID),
              ...
              (R.style.zIndex = i.zindex),
              (R.style.background = i.backgroundColor),
              (R.style.animationDuration = i.cssAnimationDuration + "ms"),
              (R.style.fontFamily = '"' + i.fontFamily + '", ' + s),
              ...
              !t.document.getElementById(R.id) &&
                (t.document.body.appendChild(R), i.clickToClose) &&
                t.document
                  .getElementById(R.id)
                  .addEventListener("click", function () {
            ...
            if (0 < e.length) {
              e =
                e.length > i.messageMaxLength
                  ? C(e).substring(0, i.messageMaxLength) + "..."
                  : C(e);
              ...
              if (n) n.innerHTML = e;
                ...
                (r.id = i.messageID),
                  (r.className = "nx-loading-message nx-loading-message-new"),
        ...
        U = function (e, o, n, i, a, l) {
          ...
          if (
            ...
            var d = {};
            "object" == typeof i ? (d = i) : "object" == typeof a && (d = a),
              (r = k(!0, r, d));
          }
          var u = "";
          "string" == typeof i && 0 < i.length && (u = i),
          ...
          if (e) {
              ...
              if ((R = L[z])) {
                ...
                if (1 > B.length) {
                  ...
                  o &&
                    (D =
                      o === g.Hourglass
                        ? S(r.svgSize, r.svgColor)
                        : o === g.Circle
                        ? E(r.svgSize, r.svgColor)
                        : o === g.Arrows
                        ? O(r.svgSize, r.svgColor)
                        : o === g.Dots
                        ? I(r.svgSize, r.svgColor)
                        : o === g.Pulse
                        ? A(r.svgSize, r.svgColor)
                        : N(r.svgSize, r.svgColor));
                  var M =
                      '<span class="' +
                      p +
                      '-icon" style="width:' +
                  ...
                  0 < u.length &&
                    ((u =
                      u.length > r.messageMaxLength
                        ? C(u).substring(0, r.messageMaxLength) + "..."
                        : C(u)),
                    (P =
                  ...
                  (W.id = y.ID + "-" + F),
                    (W.className =
                      p + (r.cssAnimation ? " nx-with-animation" : "")),
                    (W.style.position = r.position),
                    (W.style.zIndex = r.zindex),
                    (W.style.background = r.backgroundColor),
                    (W.style.animationDuration = r.cssAnimationDuration + "ms"),
                    (W.style.fontFamily = '"' + r.fontFamily + '", ' + s),
                  ...
                  var X = t.getComputedStyle(R).getPropertyValue("position"),
                    j =
                      "string" == typeof X
                        ...
                        : "relative",
                    U = Math.round(1.25 * parseInt(r.svgSize)) + 40,
                    Y = R.offsetHeight || 0,
                    _ = "";
            ...
            var Q = function (e) {
              ...
              te = setTimeout(function () {
                for (var t, e = 0; e < h; e++)
                  (t = L[e]) &&
                    (tt(t), $((B = t.querySelectorAll("[id^=" + y.ID + "]"))));
                clearTimeout(te);
              }, l);
          r = k(!0, r, f);
        },
  ...
  var _ =
    ...
    V =
      ((i = "undefined" != typeof Uint8Array && E(Uint8Array)),
      function (t) {
    ...
    $ = "0123456789",
    tt = { DIGIT: $, ALPHA: Q, ALPHA_DIGIT: Q + Q.toUpperCase() + $ },
    te = I("AsyncFunction"),
    to = {
      isArray: L,
      isArrayBuffer: T,
  ...
  [
    ...
    (s = function (t) {
      for (
        var e, o = t.length, n = o % 3, i = [], r = 0, a = o - n;
        r < a;
        r += 16383
      )
        i.push(
          (function (t, e, o) {
            for (var n, i = [], r = e; r < o; r += 3)
              i.push(
                tu[
                  ((n =
                    ((t[r] << 16) & 16711680) +
      ...
      return (
        1 === n
          ? i.push(tu[(e = t[o - 1]) >> 2] + tu[(e << 4) & 63] + "==")
          : 2 === n &&
            i.push(
              tu[(e = (t[o - 2] << 8) + t[o - 1]) >> 10] +
                tu[(e >> 4) & 63] +
                tu[(e << 2) & 63] +
                "="
            ),
  ...
  for (
    var tu = [],
      tp = [],
      tm = "undefined" != typeof Uint8Array ? Uint8Array : Array,
    ...
    (tu[tg] = th[tg]), (tp[th.charCodeAt(tg)] = tg);
  (tp["-".charCodeAt(0)] = 62),
    (tp["_".charCodeAt(0)] = 63),
    (l = function (t, e, o, n, i) {
      var r,
        a,
        s = 8 * i - n - 1,
        l = (1 << s) - 1,
      ...
      for (
        isNaN((e = Math.abs(e))) || e === 1 / 0
          ...
          : ((a = Math.floor(Math.log(e) / Math.LN2)),
            ...
            a + d >= 1 ? (e += u / l) : (e += u * Math.pow(2, 1 - d)),
            e * l >= 2 && (a++, (l /= 2)),
            a + d >= f
              ? ((s = 0), (a = f))
              : a + d >= 1
        ...
        i >= 8;
        t[o + p] = 255 & s, p += m, s /= 256, i -= 8
      );
      for (
        a = (a << i) | s, c += i;
        c > 0;
        t[o + p] = 255 & a, p += m, a /= 256, c -= 8
      );
      t[o + p - m] |= 128 * h;
    });
  var tx =
  ...
  function tw(t, e, o) {
    ...
    if (
      tK(t, ArrayBuffer) ||
      (t && tK(t.buffer, ArrayBuffer)) ||
      ("undefined" != typeof SharedArrayBuffer &&
        (tK(t, SharedArrayBuffer) || (t && tK(t.buffer, SharedArrayBuffer))))
    )
      return tS(t, e, o);
    if ("number" == typeof t)
      throw TypeError(
    ...
    if (
      ...
      return tv.from(t[Symbol.toPrimitive]("string"), e, o);
    throw TypeError(
      "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
        (void 0 === t ? "undefined" : C(t))
    );
  ...
  function tN(t) {
    for (
      var e = t.length < 0 ? 0 : 0 | tE(t.length), o = tb(e), n = 0;
      n < e;
      n += 1
    )
      o[n] = 255 & t[n];
      ...
      switch (t) {
        ...
        case "base64":
          return (
            (n = e),
            (i = o),
            0 === n && i === this.length ? s(this) : s(this.slice(n, i))
          );
        case "ucs2":
        case "ucs-2":
        case "utf16le":
  ...
  function tL(t, e, o, n, i) {
    ...
    if (("string" == typeof e && (e = tv.from(e, n)), tv.isBuffer(e)))
      return 0 === e.length ? -1 : tR(t, e, o, n, i);
    if ("number" == typeof e)
  ...
  function tW(t, e, o, n, i) {
    return (
      (e = +e),
      (o >>>= 0),
      i || tP(t, e, o, 4, 34028234663852886e22, -34028234663852886e22),
      c(t, e, o, n, 23, 4),
      o + 4
    );
  }
  function tX(t, e, o, n, i) {
    return (
      (e = +e),
      (o >>>= 0),
      i || tP(t, e, o, 8, 17976931348623157e292, -17976931348623157e292),
      c(t, e, o, n, 52, 8),
      o + 8
    );
  }
  (tv.TYPED_ARRAY_SUPPORT = (function () {
    ...
    Object.defineProperty(tv.prototype, "parent", {
      enumerable: !0,
      get: function () {
    ...
    (tv.poolSize = 8192),
    (tv.from = function (t, e, o) {
      return tw(t, e, o);
    }),
    Object.setPrototypeOf(tv.prototype, Uint8Array.prototype),
    Object.setPrototypeOf(tv, Uint8Array),
    (tv.alloc = function (t, e, o) {
      return (tk(t), t <= 0)
        ? tb(t)
        : void 0 !== e
        ? "string" == typeof o
    ...
    (tv.compare = function (t, e) {
      if (
        (tK(t, Uint8Array) && (t = tv.from(t, t.offset, t.byteLength)),
        tK(e, Uint8Array) && (e = tv.from(e, e.offset, e.byteLength)),
        !tv.isBuffer(t) || !tv.isBuffer(e))
      )
        throw TypeError(
    ...
    (tv.concat = function (t, e) {
      ...
      for (o = 0; o < t.length; ++o) {
        ...
        if (tK(r, Uint8Array))
          i + r.length > n.length
            ? (tv.isBuffer(r) || (r = tv.from(r)), r.copy(n, i))
    ...
    (tv.byteLength = tO),
    (tv.prototype._isBuffer = !0),
    (tv.prototype.swap16 = function () {
      var t = this.length;
      if (t % 2 != 0)
    ...
    (tv.prototype.toLocaleString = tv.prototype.toString),
    (tv.prototype.equals = function (t) {
    ...
    tx && (tv.prototype[tx] = tv.prototype.inspect),
    (tv.prototype.compare = function (t, e, o, n, i) {
      if (
        (tK(t, Uint8Array) && (t = tv.from(t, t.offset, t.byteLength)),
        !tv.isBuffer(t))
      )
    ...
    (tv.prototype.readUintLE = tv.prototype.readUIntLE =
      function (t, e, o) {
    ...
    (tv.prototype.readUintBE = tv.prototype.readUIntBE =
      function (t, e, o) {
        (t >>>= 0), (e >>>= 0), o || tz(t, e, this.length);
    ...
    (tv.prototype.readUint8 = tv.prototype.readUInt8 =
      function (t, e) {
        return (t >>>= 0), e || tz(t, 1, this.length), this[t];
      }),
    (tv.prototype.readUint16LE = tv.prototype.readUInt16LE =
      function (t, e) {
        return (
          (t >>>= 0), e || tz(t, 2, this.length), this[t] | (this[t + 1] << 8)
        );
      }),
    (tv.prototype.readUint16BE = tv.prototype.readUInt16BE =
      function (t, e) {
        return (
          (t >>>= 0), e || tz(t, 2, this.length), (this[t] << 8) | this[t + 1]
        );
      }),
    (tv.prototype.readUint32LE = tv.prototype.readUInt32LE =
      function (t, e) {
        return (
          (t >>>= 0),
          e || tz(t, 4, this.length),
          (this[t] | (this[t + 1] << 8) | (this[t + 2] << 16)) +
            16777216 * this[t + 3]
        );
      }),
    (tv.prototype.readUint32BE = tv.prototype.readUInt32BE =
      function (t, e) {
        return (
          (t >>>= 0),
          e || tz(t, 4, this.length),
    ...
    (tv.prototype.readBigUInt64LE = tQ(function (t) {
      ...
      var n = e + 256 * this[++t] + 65536 * this[++t] + 16777216 * this[++t],
        i = this[++t] + 256 * this[++t] + 65536 * this[++t] + 16777216 * o;
    ...
    (tv.prototype.readBigUInt64BE = tQ(function (t) {
      ...
      var e = this[t],
        o = this[t + 7];
      (void 0 === e || void 0 === o) && t_(t, this.length - 8);
      var n = 16777216 * e + 65536 * this[++t] + 256 * this[++t] + this[++t],
        i = 16777216 * this[++t] + 65536 * this[++t] + 256 * this[++t] + o;
    ...
    (tv.prototype.readInt8 = function (t, e) {
      return ((t >>>= 0), e || tz(t, 1, this.length), 128 & this[t])
        ? -((255 - this[t] + 1) * 1)
        : this[t];
    }),
    ...
    (tv.prototype.writeUintLE = tv.prototype.writeUIntLE =
      function (t, e, o, n) {
        if (((t = +t), (e >>>= 0), (o >>>= 0), !n)) {
        ...
        var r = 1,
          a = 0;
        for (this[e] = 255 & t; ++a < o && (r *= 256); )
          this[e + a] = (t / r) & 255;
        return e + o;
      }),
    (tv.prototype.writeUintBE = tv.prototype.writeUIntBE =
      function (t, e, o, n) {
        if (((t = +t), (e >>>= 0), (o >>>= 0), !n)) {
          var i = Math.pow(2, 8 * o) - 1;
          tB(this, t, e, o, i, 0);
    ...
    (tv.prototype.writeUint8 = tv.prototype.writeUInt8 =
      function (t, e, o) {
        return (
          (t = +t),
          (e >>>= 0),
          o || tB(this, t, e, 1, 255, 0),
          (this[e] = 255 & t),
          e + 1
        );
      }),
    (tv.prototype.writeUint16LE = tv.prototype.writeUInt16LE =
      function (t, e, o) {
        return (
          (t = +t),
          (e >>>= 0),
          o || tB(this, t, e, 2, 65535, 0),
          (this[e] = 255 & t),
          (this[e + 1] = t >>> 8),
          e + 2
        );
      }),
    (tv.prototype.writeUint16BE = tv.prototype.writeUInt16BE =
      function (t, e, o) {
        return (
          (t = +t),
          (e >>>= 0),
    ...
    (tv.prototype.writeUint32LE = tv.prototype.writeUInt32LE =
      function (t, e, o) {
        return (
          (t = +t),
          (e >>>= 0),
          o || tB(this, t, e, 4, 4294967295, 0),
          (this[e + 3] = t >>> 24),
          (this[e + 2] = t >>> 16),
          (this[e + 1] = t >>> 8),
          (this[e] = 255 & t),
    ...
    (tv.prototype.writeUint32BE = tv.prototype.writeUInt32BE =
      function (t, e, o) {
        return (
          (t = +t),
          (e >>>= 0),
    ...
    (tv.prototype.writeInt32LE = function (t, e, o) {
      return (
        (t = +t),
        (e >>>= 0),
        o || tB(this, t, e, 4, 2147483647, -2147483648),
        (this[e] = 255 & t),
        (this[e + 1] = t >>> 8),
        (this[e + 2] = t >>> 16),
        (this[e + 3] = t >>> 24),
    ...
    (tv.prototype.fill = function (t, e, o, n) {
      if ("string" == typeof t) {
        ...
        if ("string" == typeof n && !tv.isEncoding(n))
      ...
      if (
        ...
        var a = tv.isBuffer(t) ? t : tv.from(t, n),
          s = a.length;
        if (0 === s)
          throw TypeError(
      ...
      var n,
        i =
          ...
          function () {
            ...
            return (t = e) && ("object" === C(t) || "function" == typeof t)
              ? t
              : tc(this);
          });
      function r() {
        ...
        return (
          tn(this, r),
          Object.defineProperty(tc((o = i.call(this))), "message", {
            value: e.apply(tc(o), arguments),
            writable: !0,
            configurable: !0,
          }),
          (o.name = "".concat(o.name, " [").concat(t, "]")),
          o.stack,
          delete o.name,
          o
        );
  ...
  function tH(t, e, o, n, i, r) {
    if (t > o || t < e) {
      var a,
        s = (void 0 === e ? "undefined" : C(e)) === "bigint" ? "n" : "";
      throw (
        ((a =
          r > 3
            ? 0 === e || e === BigInt(0)
              ...
              : ">= -(2"
                  ...
                  .concat((r + 1) * 8 - 1)
                  .concat(s, ") and < 2 ** ") +
                "".concat((r + 1) * 8 - 1).concat(s)
            : ">= ".concat(e).concat(s, " and <= ").concat(o).concat(s)),
        new tj.ERR_OUT_OF_RANGE("value", a, t))
      );
    }
    tY(i, "offset"),
      (void 0 === n[i] || void 0 === n[i + r]) && t_(i, n.length - (r + 1));
  }
  function tY(t, e) {
  ...
  function t_(t, e, o) {
    if (Math.floor(t) !== t)
      throw (tY(t, o), new tj.ERR_OUT_OF_RANGE(o || "offset", "an integer", t));
    if (e < 0) throw new tj.ERR_BUFFER_OUT_OF_BOUNDS();
    throw new tj.ERR_OUT_OF_RANGE(
      o || "offset",
      ...
      function (t, e, o) {
        ...
        return (
          Number.isInteger(o) && Math.abs(o) > 4294967296
            ? (i = tU(String(o)))
            : (void 0 === o ? "undefined" : C(o)) === "bigint" &&
              ((i = String(o)),
              (o > Math.pow(BigInt(2), BigInt(32)) ||
                o < -Math.pow(BigInt(2), BigInt(32))) &&
                (i = tU(i)),
              (i += "n")),
  ...
  function tJ(t) {
    return (function (t) {
      ...
      for (o = 0; o < l; o += 4)
        (e =
          (tp[t.charCodeAt(o)] << 18) |
          (tp[t.charCodeAt(o + 1)] << 12) |
          (tp[t.charCodeAt(o + 2)] << 6) |
          tp[t.charCodeAt(o + 3)]),
          (a[s++] = (e >> 16) & 255),
          (a[s++] = (e >> 8) & 255),
          (a[s++] = 255 & e);
      return (
        2 === r &&
          ((e = (tp[t.charCodeAt(o)] << 2) | (tp[t.charCodeAt(o + 1)] >> 4)),
          (a[s++] = 255 & e)),
        1 === r &&
          ((e =
            (tp[t.charCodeAt(o)] << 10) |
            (tp[t.charCodeAt(o + 1)] << 4) |
            (tp[t.charCodeAt(o + 2)] >> 2)),
          (a[s++] = (e >> 8) & 255),
          (a[s++] = 255 & e)),
        a
      );
      ...
      (function (t) {
        if ((t = (t = t.split("=")[0]).trim().replace(tq, "")).length < 2)
          return "";
        for (; t.length % 4 != 0; ) t += "=";
        return t;
      })(t)
  ...
  var tG = (function () {
    for (var t = "0123456789abcdef", e = Array(256), o = 0; o < 16; ++o)
  ...
  var t6 = to.toFlatObject(to, {}, null, function (t) {
    ...
    t5 = function (t, e, o) {
      ...
      function l(t) {
        ...
        return to.isArrayBuffer(t) || to.isTypedArray(t)
      ...
      function c(t, o, i) {
        ...
        if (t && !i && "object" == typeof t) {
          if (to.endsWith(o, "{}"))
            ...
            (to.isArray(t) && ((s = t), to.isArray(s) && !s.some(t0))) ||
            ((to.isFileList(t) || to.endsWith(o, "[]")) && (c = to.toArray(t)))
          )
            return (
              (o = t1(o)),
      ...
      return (
        !(function t(o, n) {
          if (!to.isUndefined(o)) {
            ...
            f.push(o),
              to.forEach(o, function (o, r) {
                !0 ===
                  (!(to.isUndefined(o) || null === o) &&
                    i.call(e, o, to.isString(r) ? r.trim() : r, n, d)) &&
                  t(o, n ? n.concat(r) : [r]);
              }),
              f.pop();
          }
  ...
  function t7(t, e, o) {
    ...
    if (
      (n = r
        ? r(e, o)
        : to.isURLSearchParams(e)
        ? e.toString()
        : new t4(e, o).toString(i))
    ) {
      var a = t.indexOf("#");
      -1 !== a && (t = t.slice(0, a)),
        (t += (-1 === t.indexOf("?") ? "?" : "&") + n);
  ...
  var et = (function () {
    ...
    eo = {
      ...
      classes: {
        URLSearchParams:
          "undefined" != typeof URLSearchParams ? URLSearchParams : t4,
        FormData: "undefined" != typeof FormData ? FormData : null,
        Blob: "undefined" != typeof Blob ? Blob : null,
      },
      isStandardBrowserEnv:
        ("undefined" == typeof navigator ||
          ("ReactNative" !== (a = navigator.product) &&
            "NativeScript" !== a &&
            "NS" !== a)) &&
        "undefined" != typeof window &&
    ...
    en = function (t) {
      if (to.isFormData(t) && to.isFunction(t.entries)) {
        var e = {};
        return (
          to.forEachEntry(t, function (t, o) {
            !(function t(e, o, n, i) {
              var r = e[i++],
                a = Number.isFinite(+r),
                s = i >= e.length;
              return ((r = !r && to.isArray(n) ? n.length : r), s)
                ? (to.hasOwnProp(n, r) ? (n[r] = [n[r], o]) : (n[r] = o), !a)
                : ((n[r] && to.isObject(n[r])) || (n[r] = []),
                  t(e, o, n[r], i) &&
                    to.isArray(n[r]) &&
                    (n[r] = (function (t) {
                      var e,
    ...
    er = {
      ...
      transformRequest: [
        function (t, e) {
          var o,
            ...
            s = to.isObject(t);
          if (
            (s && to.isHTMLForm(t) && (t = new FormData(t)), to.isFormData(t))
          )
                ...
                Object.assign(
                  {
                    visitor: function (t, e, o, n) {
                      return eo.isNode && to.isBuffer(t)
      ...
      transformResponse: [
        function (t) {
          var e = this.transitional || er.transitional,
  ...
  ("use strict");
  ("use strict");
  to.forEach(["delete", "get", "head"], function (t) {
    er.headers[t] = {};
  }),
      ...
      tr(
        ...
        [
          {
            ...
            value: function (t, e, o) {
              ...
              return (
                to.isPlainObject(t) || t instanceof this.constructor
                  ? a(t, e)
                  : to.isString(t) &&
                    (t = t.trim()) &&
          ...
          },
          {
            key: "concat",
            value: function () {
              for (var t, e = arguments.length, o = Array(e), n = 0; n < e; n++)
                o[n] = arguments[n];
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                to.forEach(this, function (o, n) {
                  null != o &&
                    !1 !== o &&
                    (e[n] = t && to.isArray(o) ? o.join(", ") : o);
                }),
                e
              );
            },
        ...
        [
          ...
          },
          {
            key: "accessor",
            value: function (t) {
              var e = (this[ed] = this[ed] = { accessors: {} }).accessors,
                o = this.prototype;
              function n(t) {
                var n,
                  i = eu(t);
  ...
  ("use strict");
  function ex(t, e, o) {
    ta.call(this, null == t ? "canceled" : t, ta.ERR_CANCELED, e, o),
  ...
  eh.accessor([
    ...
    to.freezeMethods(eh.prototype),
    to.freezeMethods(eh),
    to.inherits(ex, ta, { __CANCEL__: !0 });
  var eb = eo.isStandardBrowserEnv
    ? {
        write: function (t, e, o, n, i, r) {
          var a = [];
          a.push(t + "=" + encodeURIComponent(e)),
            to.isNumber(o) && a.push("expires=" + new Date(o).toGMTString()),
            to.isString(n) && a.push("path=" + n),
            to.isString(i) && a.push("domain=" + i),
            !0 === r && a.push("secure"),
  ...
  ("use strict");
  ("use strict");
  var ew = eo.isStandardBrowserEnv
      ? (function () {
          var t,
        ...
        return new Promise(function (e, o) {
          ...
          if (
            (c.open(
              ...
              t7(u, t.params, t.paramsSerializer),
              !0
            ),
            (c.timeout = t.timeout),
            "onloadend" in c
            ...
            (c.onabort = function () {
              c &&
                (o(new ta("Request aborted", ta.ECONNABORTED, t, c)),
                (c = null));
            }),
            (c.onerror = function () {
            ...
            (c.ontimeout = function () {
              ...
              t.timeoutErrorMessage && (e = t.timeoutErrorMessage),
                o(
                  new ta(
                    e,
                    n.clarifyTimeoutError ? ta.ETIMEDOUT : ta.ECONNABORTED,
                    t,
                    c
                  )
                ),
            ...
            var m =
              (t.withCredentials || ew(u)) &&
              t.xsrfCookieName &&
              eb.read(t.xsrfCookieName);
            m && a.set(t.xsrfHeaderName, m);
          }
          void 0 === r && a.setContentType(null),
            "setRequestHeader" in c &&
              to.forEach(a.toJSON(), function (t, e) {
                c.setRequestHeader(e, t);
              }),
            to.isUndefined(t.withCredentials) ||
              (c.withCredentials = !!t.withCredentials),
            s && "json" !== s && (c.responseType = t.responseType),
            "function" == typeof t.onDownloadProgress &&
              c.addEventListener("progress", eC(t.onDownloadProgress, !0)),
            "function" == typeof t.onUploadProgress &&
              c.upload &&
              c.upload.addEventListener("progress", eC(t.onUploadProgress)),
            (t.cancelToken || t.signal) &&
              ((i = function (e) {
                c &&
                  (o(!e || e.type ? new ex(null, t, c) : e),
                  c.abort(),
                  (c = null));
              }),
  ...
  var eS = {
    getAdapter: function (t) {
      for (
        var e, o, n = (t = to.isArray(t) ? t : [t]).length, i = 0;
        i < n && ((e = t[i]), !(o = to.isString(e) ? eN[e.toLowerCase()] : e));
        i++
      );
      if (!o) {
        if (!1 === o)
  ...
  function eO(t) {
    return (
      eE(t),
      (t.headers = eh.from(t.headers)),
      (t.data = eg.call(t, t.transformRequest)),
      -1 !== ["post", "put", "patch"].indexOf(t.method) &&
        t.headers.setContentType("application/x-www-form-urlencoded", !1),
      eS
        .getAdapter(t.adapter || er.adapter)(t)
        .then(
          function (e) {
            return (
              eE(t),
              (e.data = eg.call(t, t.transformResponse, e)),
              (e.headers = eh.from(e.headers)),
              e
            );
          },
          function (e) {
            return (
              !ey(e) &&
                ...
                e &&
                  e.response &&
                  ((e.response.data = eg.call(
                    t,
                    t.transformResponse,
                    e.response
                  )),
                  (e.response.headers = eh.from(e.response.headers)))),
              Promise.reject(e)
            );
          }
        )
  ...
  function eA(t, e) {
    ...
    var o = {};
    function n(t, e, o) {
      return to.isPlainObject(t) && to.isPlainObject(e)
        ? to.merge.call({ caseless: o }, t, e)
        : to.isPlainObject(e)
        ? to.merge({}, e)
        : to.isArray(e)
        ? e.slice()
    ...
    return (
      to.forEach(Object.keys(Object.assign({}, t, e)), function (n) {
        var r = l[n] || i,
          a = r(t[n], e[n], n);
  ...
  var ez = {
      assertOptions: function (t, e, o) {
        if ("object" != typeof t)
          throw new ta("options must be an object", ta.ERR_BAD_OPTION_VALUE);
        ...
        tr(t, [
          {
            ...
            value: function (t, e) {
              ...
              var o,
                n,
                i,
                r = (e = eA(this.defaults, e)).transitional,
                a = e.paramsSerializer,
                s = e.headers;
              void 0 !== r &&
                ez.assertOptions(
                  r,
                ...
                (o = s && to.merge(s.common, s[e.method])) &&
                  to.forEach(
          ...
          },
          {
            ...
            value: function (t) {
              return t7(
                ev((t = eA(this.defaults, t)).baseURL, t.url),
                t.params,
                t.paramsSerializer
              );
            },
  ...
  to.forEach(["delete", "get", "head", "options"], function (t) {
    eD.prototype[t] = function (e, o) {
      return this.request(
        eA(o || {}, { method: t, url: e, data: (o || {}).data })
      );
    };
  }),
    to.forEach(["post", "put", "patch"], function (t) {
  ...
  var eM = (function () {
      function t(e) {
        if ((tn(this, t), "function" != typeof e))
  ...
  var eW = (function t(e) {
    var o = new eD(e),
      n = N(eD.prototype.request, o);
    return (
      to.extend(n, eD.prototype, o, { allOwnKeys: !0 }),
      to.extend(n, o, null, { allOwnKeys: !0 }),
      (n.create = function (o) {
        return t(eA(e, o));
      }),
      n
          ...
          case 0:
            return (
              ...
              [
                4,
                eW.get(
                  "https://pixabay.com/api/?key=37512295-7e92ae3b8c2d51cd4aec1f8a1&q="
                    .concat(
                      t,
  ...
  (eW.Axios = eD),
    ...
    (eW.mergeConfig = eA),
    (eW.AxiosHeaders = eh),
    (eW.formToJSON = function (t) {
      return en(to.isHTMLForm(t) ? new FormData(t) : t);
    }),
    (eW.HttpStatusCode = eP),
    (eW.default = eW),
    eW.Axios,
    eW.AxiosError,
    eW.CanceledError,
    ...
    eW.formToJSON,
    eW.mergeConfig;
  var eF = document.querySelector(".search-form"),
    eU = eF[0],
    eH = document.querySelector(".load-more"),
    eY = document.querySelector(".gallery");
  ...
  eF.addEventListener("submit", function (t) {
    t.preventDefault(),
      "" !== eU.value.trim() &&
        ((f = 1),
        (eY.innerHTML = " "),
        eX(eU.value, f, 40).then(function (t) {
          var e = t.data;
          if (0 === e.total) {
            w(
      ...
      (f += 1),
        eX(eU.value, f, 40)
          .then(function (t) {
            ...
            var e = t.data;
            e.hits.length < 40 &&
              (w("We're sorry, but you've reached the end of search results."),
              eH.classList.add("is-hidden"));
            var o = e.hits.map(function (t) {
              return eq(t);
            });
...
//# sourceMappingURL=index.9e4828a7.js.map
