...
module.bundle.HMR_BUNDLE_ID = "4fdc406b01ba9b90";
"use strict";
...
},{}],"3GNOW":[function(require,module,exports) {
var global = arguments[3];
let t;
function e(t) {
...
"use strict";
var o, i, n, a, r, s = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : {}, l = {};
function c(t) {
...
function f(t, e) {
    ...
    if (!o) {
        if (Array.isArray(t) || (o = d(t)) || e && t && "number" == typeof t.length) {
            o && (t = o);
            var i = 0, n = function() {};
            return {
                s: n,
...
var h = function() {
    ...
    function o(t, e) {
        ...
        this.createDomNodes(), this.options.close && this.domNodes.wrapper.appendChild(this.domNodes.closeButton), this.options.nav && this.domNodes.wrapper.appendChild(this.domNodes.navigation), this.options.spinner && this.domNodes.wrapper.appendChild(this.domNodes.spinner), this.addEventListener(this.elements, "click." + this.eventNamespace, function(t) {
            ...
            if (i.controlCoordinates.swipeDiff = 0, i.isAnimating && "Escape" === t.key) {
                i.currentImage.setAttribute("src", ""), i.isAnimating = !1, i.close();
                return;
            }
            i.isOpen && (t.preventDefault(), "Escape" === t.key && i.close(), !i.isAnimating && [
                "ArrowLeft",
                "ArrowRight"
            ].indexOf(t.key) > -1 && i.loadImage("ArrowRight" === t.key ? 1 : -1));
    ...
    return t = [
        ...
        },
        {
            ...
            value: function(t) {
                var e = t.tagName, o = t.id, i = t.className, n = t.parentNode;
                if ("HTML" === e) return "HTML";
                var a = e;
                if (a += "" !== o ? "#".concat(o) : "", i) for(var r = i.trim().split(/\s/), s = 0; s < r.length; s++)a += ".".concat(r[s]);
                for(var l = 1, c = t; c.previousElementSibling; c = c.previousElementSibling)l += 1;
                return a += ":nth-child(".concat(l, ")"), "".concat(this.generateQuerySelector(n), " > ").concat(a);
            }
        },
        {
            key: "createDomNodes",
            ...
            value: function(t) {
                ...
                if ("hide" === t) {
                    ...
                    if (document.body.clientWidth < i || this.isAppleDevice) {
                        var a = parseInt(window.getComputedStyle(document.body).paddingRight || 0, 10);
                        e = this.getScrollbarWidth(), document.body.dataset.originalPaddingRight = a, (e > 0 || 0 == e && this.isAppleDevice) && (document.body.classList.add("hidden-scroll"), document.body.style.paddingRight = a + e + "px", o.forEach(function(t) {
                            var o = t.style.paddingRight, i = window.getComputedStyle(t)["padding-right"];
                            t.dataset.originalPaddingRight = o, t.style.paddingRight = "".concat(parseFloat(i) + e, "px");
                        }));
                    }
        ...
        },
        {
            key: "preload",
            value: function() {
                var t = this, e = this.currentImageIndex, o = this.relatedElements.length, i = new Image(), n = new Image();
                i.addEventListener("load", function(o) {
                    var i = o.target.getAttribute("src");
                    -1 === t.loadedImages.indexOf(i) && t.loadedImages.push(i), t.relatedElements[e].dispatchEvent(new Event("nextImageLoaded." + t.eventNamespace));
                }), i.setAttribute("src", this.relatedElements[e + 1 < 0 ? o - 1 : e + 1 >= o - 1 ? 0 : e + 1].getAttribute(this.options.sourceAttr)), n.addEventListener("load", function(o) {
                    var i = o.target.getAttribute("src");
                    -1 === t.loadedImages.indexOf(i) && t.loadedImages.push(i), t.relatedElements[e].dispatchEvent(new Event("prevImageLoaded." + t.eventNamespace));
                }), n.setAttribute("src", this.relatedElements[e - 1 < 0 ? o - 1 : e - 1 >= o - 1 ? 0 : e - 1].getAttribute(this.options.sourceAttr));
            }
        },
        {
            key: "loadImage",
        ...
        },
        {
            ...
            value: function(t) {
                ...
                var o = new Image(), i = window.innerWidth * this.options.widthRatio, n = window.innerHeight * this.options.heightRatio;
                o.setAttribute("src", this.currentImage.getAttribute("src")), this.currentImage.dataset.scale = 1, this.currentImage.dataset.translateX = 0, this.currentImage.dataset.translateY = 0, this.zoomPanElement(0, 0, 1), o.addEventListener("error", function(o) {
                    ...
                    e.options.alertError && alert(e.options.alertErrorMessage), e.loadImage(i ? t : 1);
                    ...
                    var a, r, s = o.target.width, l = o.target.height;
            ...
            value: function() {
                ...
                if (this.addEventListener(window, "resize." + this.eventNamespace, function(e) {
                    ...
                    this.addEventListener(this.domNodes.image, [
                        ...
                        void 0 === i && (i = o.detail), i = Math.max(-1, Math.min(1, i)), e += i * t.options.scrollZoomFactor * e, e = Math.max(1, Math.min(t.options.maxZoom, e)), t.controlCoordinates.targetScale = e;
        ...
        },
        {
            key: "getDimensions",
            value: function(t) {
                var e = window.getComputedStyle(t), o = t.offsetHeight, i = t.offsetWidth, n = parseFloat(e.borderTopWidth);
                return {
                        ...
                        try {
                            for(l.s(); !(s = l.n()).done;){
                                ...
                                [
                                    ...
                                    "mousewheel",
                                    "DOMMouseScroll"
                                ].indexOf(d.split(".")[0]) >= 0 && this.isPassiveEventsSupported && ("object" === c(p) ? p.passive = !0 : p = {
                                    passive: !0
                                }), r.namespaces[d] = o, r.addEventListener(d.split(".")[0], o, p);
                            }
                        } catch (t) {
                            l.e(t);
                        } finally{
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                try {
                    for(i.s(); !(o = i.n()).done;){
                        var n, a = o.value, r = f(e);
                        try {
                            for(r.s(); !(n = r.n()).done;){
                                var s = n.value;
                                a.namespaces && a.namespaces[s] && (a.removeEventListener(s.split(".")[0], a.namespaces[s]), delete a.namespaces[s]);
                            }
                        } catch (t) {
                            r.e(t);
                        } finally{
        ...
        },
        {
            key: "fadeOut",
            value: function(t, e, o) {
                var i, n = this, a = f(t = this.wrap(t));
                try {
                    for(a.s(); !(i = a.n()).done;){
                        var r = i.value;
                        r.style.opacity = parseFloat(r) || window.getComputedStyle(r).getPropertyValue("opacity");
                    }
                } catch (t) {
                    a.e(t);
                } finally{
        ...
        },
        {
            key: "fadeIn",
            value: function(t, e, o, i) {
                var n, a = this, r = f(t = this.wrap(t));
                try {
                    for(r.s(); !(n = r.n()).done;){
                        var s = n.value;
        ...
        },
        {
            ...
            value: function(t) {
                ...
                try {
                    for(o.s(); !(e = o.n()).done;){
                        var i, n = e.value, a = f(t);
                        try {
                            for(a.s(); !(i = a.n()).done;){
                                var r = i.value;
                                void 0 !== n.fullyNamespacedEvents && r in n.fullyNamespacedEvents && n.removeEventListener(r, n.fullyNamespacedEvents[r]);
                            }
                        } catch (t) {
                            a.e(t);
                        } finally{
    ...
    ], m(o.prototype, t), e && m(o, e), Object.defineProperty(o, "prototype", {
        writable: !1
    }), o;
}();
...
!function(t, e) {
    "function" == typeof define && define.amd ? define([], function() {
        return e(t);
    }) : "object" == typeof g ? g = e(t) : t.Notiflix = e(t);
}(void 0 === s ? "undefined" == typeof window ? g : window : s, function(t) {
    "use strict";
    ...
    var e, o, i, n, a, r = "\n\nVisit documentation page to learn more: https://notiflix.github.io/documentation", s = '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif', l = {
        ...
        for("[object Boolean]" === Object.prototype.toString.call(arguments[0]) && (e = arguments[0], o++); o < arguments.length; o++)!function(o) {
            for(var i in o)Object.prototype.hasOwnProperty.call(o, i) && (t[i] = e && "[object Object]" === Object.prototype.toString.call(o[i]) ? k(t[i], o[i]) : o[i]);
        }(arguments[o]);
        return t;
    }, C = function(e) {
    ...
    }, R = 0, T = function(o, i, n, a) {
        if (!w("body")) return !1;
        e || H.Notify.init({});
        var r = k(!0, e, {});
        if ("object" == typeof n && !Array.isArray(n) || "object" == typeof a && !Array.isArray(a)) {
            var f = {};
            "object" == typeof n ? f = n : "object" == typeof a && (f = a), e = k(!0, e, f);
        }
        var d = e[o.toLocaleLowerCase("en")];
        R++, "string" != typeof i && (i = "Notiflix " + o), e.plainText && (i = C(i)), !e.plainText && i.length > e.messageMaxLength && (e = k(!0, e, {
            closeButton: !0,
        ...
        var p = t.document.getElementById(c.wrapID) || t.document.createElement("div");
        if (p.id = c.wrapID, p.style.width = e.width, p.style.zIndex = e.zindex, p.style.opacity = e.opacity, "center-center" === e.position ? (p.style.left = e.distance, p.style.top = e.distance, p.style.right = e.distance, p.style.bottom = e.distance, p.style.margin = "auto", p.classList.add("nx-flex-center-center"), p.style.maxHeight = "calc((100vh - " + e.distance + ") - " + e.distance + ")", p.style.display = "flex", p.style.flexWrap = "wrap", p.style.flexDirection = "column", p.style.justifyContent = "center", p.style.alignItems = "center", p.style.pointerEvents = "none") : "center-top" === e.position ? (p.style.left = e.distance, p.style.right = e.distance, p.style.top = e.distance, p.style.bottom = "auto", p.style.margin = "auto") : "center-bottom" === e.position ? (p.style.left = e.distance, p.style.right = e.distance, p.style.bottom = e.distance, p.style.top = "auto", p.style.margin = "auto") : "right-bottom" === e.position ? (p.style.right = e.distance, p.style.bottom = e.distance, p.style.top = "auto", p.style.left = "auto") : "left-top" === e.position ? (p.style.left = e.distance, p.style.top = e.distance, p.style.right = "auto", p.style.bottom = "auto") : "left-bottom" === e.position ? (p.style.left = e.distance, p.style.bottom = e.distance, p.style.top = "auto", p.style.right = "auto") : (p.style.right = e.distance, p.style.top = e.distance, p.style.left = "auto", p.style.bottom = "auto"), e.backOverlay) {
            var m = t.document.getElementById(c.overlayID) || t.document.createElement("div");
            m.id = c.overlayID, m.style.width = "100%", m.style.height = "100%", m.style.position = "fixed", m.style.zIndex = e.zindex - 1, m.style.left = 0, m.style.top = 0, m.style.right = 0, m.style.bottom = 0, m.style.background = d.backOverlayColor || e.backOverlayColor, m.className = e.cssAnimation ? "nx-with-animation" : "", m.style.animationDuration = e.cssAnimation ? e.cssAnimationDuration + "ms" : "", t.document.getElementById(c.overlayID) || t.document.body.appendChild(m);
        }
        t.document.getElementById(c.wrapID) || t.document.body.appendChild(p);
        var u = t.document.createElement("div");
        u.id = e.ID + "-" + R, u.className = e.className + " " + d.childClassName + " " + (e.cssAnimation ? "nx-with-animation" : "") + " " + (e.useIcon ? "nx-with-icon" : "") + " nx-" + e.cssAnimationStyle + " " + (e.closeButton && "function" != typeof n ? "nx-with-close-button" : "") + " " + ("function" == typeof n ? "nx-with-callback" : "") + " " + (e.clickToClose ? "nx-notify-click-to-close" : ""), u.style.fontSize = e.fontSize, u.style.color = d.textColor, u.style.background = d.background, u.style.borderRadius = e.borderRadius, u.style.pointerEvents = "all", e.rtl && (u.setAttribute("dir", "rtl"), u.classList.add("nx-rtl-on")), u.style.fontFamily = '"' + e.fontFamily + '", ' + s, e.cssAnimation && (u.style.animationDuration = e.cssAnimationDuration + "ms");
        var h = "";
        if (e.closeButton && "function" != typeof n && (h = '<span class="nx-close-button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><g><path fill="' + d.notiflixIconColor + '" d="M0.38 2.19l7.8 7.81 -7.8 7.81c-0.51,0.5 -0.51,1.31 -0.01,1.81 0.25,0.25 0.57,0.38 0.91,0.38 0.34,0 0.67,-0.14 0.91,-0.38l7.81 -7.81 7.81 7.81c0.24,0.24 0.57,0.38 0.91,0.38 0.34,0 0.66,-0.14 0.9,-0.38 0.51,-0.5 0.51,-1.31 0,-1.81l-7.81 -7.81 7.81 -7.81c0.51,-0.5 0.51,-1.31 0,-1.82 -0.5,-0.5 -1.31,-0.5 -1.81,0l-7.81 7.81 -7.81 -7.81c-0.5,-0.5 -1.31,-0.5 -1.81,0 -0.51,0.51 -0.51,1.32 0,1.82z"/></g></svg></span>'), e.useIcon) {
            if (e.useFontAwesome) u.innerHTML = '<i style="color:' + d.fontAwesomeIconColor + "; font-size:" + e.fontAwesomeIconSize + ';" class="nx-message-icon nx-message-icon-fa ' + d.fontAwesomeClassName + " " + ("shadow" === e.fontAwesomeIconStyle ? "nx-message-icon-fa-shadow" : "nx-message-icon-fa-basic") + '"></i><span class="nx-message nx-with-icon">' + i + "</span>" + (e.closeButton ? h : "");
            else {
                var g = "";
        ...
        } else u.innerHTML = '<span class="nx-message">' + i + "</span>" + (e.closeButton ? h : "");
        ...
        if (x) {
            var b, v, N = function() {
                ...
                e && 0 >= p.childElementCount && e.classList.add("nx-remove"), clearTimeout(b);
            }, S = function() {
                if (x && null !== x.parentNode && x.parentNode.removeChild(x), 0 >= p.childElementCount && null !== p.parentNode) {
            ...
            if (e.closeButton && "function" != typeof n && t.document.getElementById(u.id).querySelector("span.nx-close-button").addEventListener("click", function() {
                N();
                var t = setTimeout(function() {
                    S(), clearTimeout(t);
                }, e.cssAnimationDuration);
            }), ("function" == typeof n || e.clickToClose) && x.addEventListener("click", function() {
                ...
                E(), e.pauseOnHover && (x.addEventListener("mouseenter", function() {
                    x.classList.add("nx-paused"), clearTimeout(b), clearTimeout(v);
        ...
        if (!w("body")) return !1;
        o || H.Report.init({});
        var c, p, m, u, h, g, y, x, b = {};
        if ("object" == typeof r && !Array.isArray(r) || "object" == typeof l && !Array.isArray(l)) {
            var v = {};
            "object" == typeof r ? v = r : "object" == typeof l && (v = l), b = k(!0, o, {}), o = k(!0, o, v);
        }
        var N = o[e.toLocaleLowerCase("en")];
        "string" != typeof i && (i = "Notiflix " + e), "string" != typeof n && (e === f.Success ? n = '"Do not try to become a person of success but try to become a person of value." <br><br>- Albert Einstein' : e === f.Failure ? n = '"Failure is simply the opportunity to begin again, this time more intelligently." <br><br>- Henry Ford' : e === f.Warning ? n = '"The peoples who want to live comfortably without producing and fatigue; they are doomed to lose their dignity, then liberty, and then independence and destiny." <br><br>- Mustafa Kemal Ataturk' : e === f.Info && (n = '"Knowledge rests not upon truth alone, but upon error also." <br><br>- Carl Gustav Jung')), "string" != typeof a && (a = "Okay"), o.plainText && (i = C(i), n = C(n), a = C(a)), o.plainText || (i.length > o.titleMaxLength && (i = "Possible HTML Tags Error", n = 'The "plainText" option is "false" and the title content length is more than the "titleMaxLength" option.', a = "Okay"), n.length > o.messageMaxLength && (i = "Possible HTML Tags Error", n = 'The "plainText" option is "false" and the message content length is more than the "messageMaxLength" option.', a = "Okay"), a.length > o.buttonMaxLength && (i = "Possible HTML Tags Error", n = 'The "plainText" option is "false" and the button content length is more than the "buttonMaxLength" option.', a = "Okay")), i.length > o.titleMaxLength && (i = i.substring(0, o.titleMaxLength) + "..."), n.length > o.messageMaxLength && (n = n.substring(0, o.messageMaxLength) + "..."), a.length > o.buttonMaxLength && (a = a.substring(0, o.buttonMaxLength) + "..."), o.cssAnimation || (o.cssAnimationDuration = 0);
        ...
        i || H.Confirm.init({});
        var u = k(!0, i, {});
        "object" != typeof d || Array.isArray(d) || (i = k(!0, i, d)), "string" != typeof o && (o = "Notiflix Confirm"), "string" != typeof n && (n = "Do you agree with me?"), "string" != typeof r && (r = "Yes"), "string" != typeof l && (l = "No"), "function" != typeof c && (c = void 0), "function" != typeof f && (f = void 0), i.plainText && (o = C(o), n = C(n), r = C(r), l = C(l)), i.plainText || (o.length > i.titleMaxLength && (o = "Possible HTML Tags Error", n = 'The "plainText" option is "false" and the title content length is more than "titleMaxLength" option.', r = "Okay", l = "..."), n.length > i.messageMaxLength && (o = "Possible HTML Tags Error", n = 'The "plainText" option is "false" and the message content length is more than "messageMaxLength" option.', r = "Okay", l = "..."), (r.length || l.length) > i.buttonsMaxLength && (o = "Possible HTML Tags Error", n = 'The "plainText" option is "false" and the buttons content length is more than "buttonsMaxLength" option.', r = "Okay", l = "...")), o.length > i.titleMaxLength && (o = o.substring(0, i.titleMaxLength) + "..."), n.length > i.messageMaxLength && (n = n.substring(0, i.messageMaxLength) + "..."), r.length > i.buttonsMaxLength && (r = r.substring(0, i.buttonsMaxLength) + "..."), l.length > i.buttonsMaxLength && (l = l.substring(0, i.buttonsMaxLength) + "..."), i.cssAnimation || (i.cssAnimationDuration = 0);
        var h = t.document.createElement("div");
        h.id = m.ID, h.className = i.className + (i.cssAnimation ? " nx-with-animation nx-" + i.cssAnimationStyle : ""), h.style.zIndex = i.zindex, h.style.padding = i.distance, i.rtl && (h.setAttribute("dir", "rtl"), h.classList.add("nx-rtl-on"));
        var g = "string" == typeof i.position ? i.position.trim() : "center";
        h.classList.add("nx-position-" + g), h.style.fontFamily = '"' + i.fontFamily + '", ' + s;
        var y = "";
        i.backOverlay && (y = '<div class="' + i.className + "-overlay" + (i.cssAnimation ? " nx-with-animation" : "") + '" style="background:' + i.backOverlayColor + ";animation-duration:" + i.cssAnimationDuration + 'ms;"></div>');
        var x = "";
        "function" == typeof c && (x = '<a id="NXConfirmButtonCancel" class="nx-confirm-button-cancel" style="color:' + i.cancelButtonColor + ";background:" + i.cancelButtonBackground + ";font-size:" + i.buttonsFontSize + ';">' + l + "</a>");
        var b = "", v = null, N = void 0;
        if (e === p.Ask || e === p.Prompt) {
            v = a || "";
            var S = e === p.Ask ? Math.ceil(1.5 * v.length) : 200 < v.length ? Math.ceil(1.5 * v.length) : 250;
            b = '<div><input id="NXConfirmValidationInput" type="text" ' + (e === p.Prompt ? 'value="' + v + '"' : "") + ' maxlength="' + S + '" style="font-size:' + i.messageFontSize + ";border-radius: " + i.borderRadius + ';" autocomplete="off" spellcheck="false" autocapitalize="none" /></div>';
        }
        if (h.innerHTML = y + '<div class="' + i.className + '-content" style="width:' + i.width + "; background:" + i.backgroundColor + "; animation-duration:" + i.cssAnimationDuration + "ms; border-radius: " + i.borderRadius + ';"><div class="' + i.className + '-head"><h5 style="color:' + i.titleColor + ";font-size:" + i.titleFontSize + ';">' + o + '</h5><div style="color:' + i.messageColor + ";font-size:" + i.messageFontSize + ';">' + n + b + '</div></div><div class="' + i.className + '-buttons"><a id="NXConfirmButtonOk" class="nx-confirm-button-ok' + ("function" == typeof c ? "" : " nx-full") + '" style="color:' + i.okButtonColor + ";background:" + i.okButtonBackground + ";font-size:" + i.buttonsFontSize + ';">' + r + "</a>" + x + "</div></div>", !t.document.getElementById(h.id)) {
            ...
            I && (I.focus(), I.setSelectionRange(0, (I.value || "").length), I.addEventListener("keyup", function(t) {
                ...
                e === p.Ask && o !== v ? (t.preventDefault(), I.classList.add("nx-validation-failure"), I.classList.remove("nx-validation-success")) : (e === p.Ask && (I.classList.remove("nx-validation-failure"), I.classList.add("nx-validation-success")), ("enter" === (t.key || "").toLocaleLowerCase("en") || 13 === t.keyCode) && O.dispatchEvent(new Event("click")));
            })), O.addEventListener("click", function(t) {
                if (e === p.Ask && v && I) {
                    if ((I.value || "").toString() !== v) return I.focus(), I.classList.add("nx-validation-failure"), t.stopPropagation(), t.preventDefault(), t.returnValue = !1, t.cancelBubble = !0, !1;
                    I.classList.remove("nx-validation-failure");
                }
                "function" == typeof c && (e === p.Prompt && I && (N = I.value || ""), c(N)), E.classList.add("nx-remove");
                ...
                "function" == typeof f && (e === p.Prompt && I && (N = I.value || ""), f(N)), E.classList.add("nx-remove");
                var t = setTimeout(function() {
        ...
        n || H.Loading.init({});
        var l = k(!0, n, {});
        if ("object" == typeof o && !Array.isArray(o) || "object" == typeof i && !Array.isArray(i)) {
            var c = {};
            "object" == typeof o ? c = o : "object" == typeof i && (c = i), n = k(!0, n, c);
        }
        var f = "";
        if ("string" == typeof o && 0 < o.length && (f = o), a) {
            f = f.length > n.messageMaxLength ? C(f).toString().substring(0, n.messageMaxLength) + "..." : C(f).toString();
            var d, p, m = "";
            0 < f.length && (m = '<p id="' + n.messageID + '" class="nx-loading-message" style="color:' + n.messageColor + ";font-size:" + n.messageFontSize + ';">' + f + "</p>"), n.cssAnimation || (n.cssAnimationDuration = 0);
            var g = "";
            ...
            else if (e === u.Custom && null !== n.customSvgCode && null === n.customSvgUrl) g = n.customSvgCode || "";
            else if (e === u.Custom && null !== n.customSvgUrl && null === n.customSvgCode) g = '<img class="nx-custom-loading-icon" width="' + n.svgSize + '" height="' + n.svgSize + '" src="' + n.customSvgUrl + '" alt="Notiflix">';
            else {
                if (e === u.Custom && (null === n.customSvgUrl || null === n.customSvgCode)) return x('You have to set a static SVG url to "customSvgUrl" option to use Loading Custom.'), !1;
                (d = n.svgSize) || (d = "60px"), g = '<svg xmlns="http://www.w3.org/2000/svg" id="NXLoadingNotiflixLib" width="' + d + '" height="' + d + '" viewBox="0 0 200 200"><defs><style>@keyframes notiflix-n{0%{stroke-dashoffset:1000}to{stroke-dashoffset:0}}@keyframes notiflix-x{0%{stroke-dashoffset:1000}to{stroke-dashoffset:0}}@keyframes notiflix-dot{0%,to{stroke-width:0}50%{stroke-width:12}}.nx-icon-line{stroke:#f8f8f8;stroke-width:12;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:22;fill:none}</style></defs><path d="M47.97 135.05a6.5 6.5 0 1 1 0 13 6.5 6.5 0 0 1 0-13z" style="animation-name:notiflix-dot;animation-timing-function:ease-in-out;animation-duration:1.25s;animation-iteration-count:infinite;animation-direction:normal" fill="' + (p = "#32c682") + '" stroke="' + p + '" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="22" stroke-width="12"/><path class="nx-icon-line" d="M10.14 144.76V87.55c0-5.68-4.54-41.36 37.83-41.36 42.36 0 37.82 35.68 37.82 41.36v57.21" style="animation-name:notiflix-n;animation-timing-function:linear;animation-duration:2.5s;animation-delay:0s;animation-iteration-count:infinite;animation-direction:normal" stroke-dasharray="500"/><path class="nx-icon-line" d="M115.06 144.49c24.98-32.68 49.96-65.35 74.94-98.03M114.89 46.6c25.09 32.58 50.19 65.17 75.29 97.75" style="animation-name:notiflix-x;animation-timing-function:linear;animation-duration:2.5s;animation-delay:.2s;animation-iteration-count:infinite;animation-direction:normal" stroke-dasharray="500"/></svg>';
            }
            var y = parseInt((n.svgSize || "").replace(/[^0-9]/g, "")), b = t.innerWidth, v = y >= b ? b - 40 + "px" : y + "px", L = '<div style="width:' + v + "; height:" + v + ';" class="' + n.className + "-icon" + (0 < f.length ? " nx-with-message" : "") + '">' + g + "</div>", R = t.document.createElement("div");
            R.id = h.ID, R.className = n.className + (n.cssAnimation ? " nx-with-animation" : "") + (n.clickToClose ? " nx-loading-click-to-close" : ""), R.style.zIndex = n.zindex, R.style.background = n.backgroundColor, R.style.animationDuration = n.cssAnimationDuration + "ms", R.style.fontFamily = '"' + n.fontFamily + '", ' + s, R.style.display = "flex", R.style.flexWrap = "wrap", R.style.flexDirection = "column", R.style.alignItems = "center", R.style.justifyContent = "center", n.rtl && (R.setAttribute("dir", "rtl"), R.classList.add("nx-rtl-on")), R.innerHTML = L + m, !t.document.getElementById(R.id) && (t.document.body.appendChild(R), n.clickToClose) && t.document.getElementById(R.id).addEventListener("click", function() {
        ...
        if (o) {
            if (0 < e.length) {
                e = e.length > n.messageMaxLength ? C(e).substring(0, n.messageMaxLength) + "..." : C(e);
                var i = o.getElementsByTagName("p")[0];
                if (i) i.innerHTML = e;
                else {
                    var a = t.document.createElement("p");
                    a.id = n.messageID, a.className = "nx-loading-message nx-loading-message-new", a.style.color = n.messageColor, a.style.fontSize = n.messageFontSize, a.innerHTML = e, o.appendChild(a);
                }
    ...
    }, j = 0, U = function(e, o, i, n, r, l) {
        if (Array.isArray(i)) {
            if (1 > i.length) return x("Array of HTMLElements should contains at least one HTMLElement."), !1;
            L = i;
        } else if (Object.prototype.isPrototypeOf.call(NodeList.prototype, i)) {
            if (1 > i.length) return x("NodeListOf<HTMLElement> should contains at least one HTMLElement."), !1;
            L = Array.prototype.slice.call(i);
        } else {
            if ("string" != typeof i || 1 > (i || "").length || 1 === (i || "").length && ("#" === (i || "")[0] || "." === (i || "")[0])) return x("The selector parameter must be a string and matches a specified CSS selector(s)."), !1;
            var c = t.document.querySelectorAll(i);
            if (1 > c.length) return x('You called the "Notiflix.Block..." function with "' + i + '" selector, but there is no such element(s) in the document.'), !1;
            L = c;
        }
        a || H.Block.init({});
        var f = k(!0, a, {});
        if ("object" == typeof n && !Array.isArray(n) || "object" == typeof r && !Array.isArray(r)) {
            var d = {};
            "object" == typeof n ? d = n : "object" == typeof r && (d = r), a = k(!0, a, d);
        }
        var p = "";
        "string" == typeof n && 0 < n.length && (p = n), a.cssAnimation || (a.cssAnimationDuration = 0);
        var m = y.className;
        "string" == typeof a.className && (m = a.className.trim());
        var u = "number" == typeof a.querySelectorLimit ? a.querySelectorLimit : 200, h = (L || []).length >= u ? u : L.length, v = "nx-block-temporary-position";
        if (e) {
            for(var L, R, T = [
                "area",
                "base",
                ...
                if (1 > B.length) {
                    var D = "";
                    o && (D = o === g.Hourglass ? S(a.svgSize, a.svgColor) : o === g.Circle ? E(a.svgSize, a.svgColor) : o === g.Arrows ? O(a.svgSize, a.svgColor) : o === g.Dots ? I(a.svgSize, a.svgColor) : o === g.Pulse ? A(a.svgSize, a.svgColor) : N(a.svgSize, a.svgColor));
                    var M = '<span class="' + m + '-icon" style="width:' + a.svgSize + ";height:" + a.svgSize + ';">' + D + "</span>", P = "";
                    0 < p.length && (p = p.length > a.messageMaxLength ? C(p).substring(0, a.messageMaxLength) + "..." : C(p), P = '<span style="font-size:' + a.messageFontSize + ";color:" + a.messageColor + ';" class="' + m + '-message">' + p + "</span>"), j++;
                    var W = t.document.createElement("div");
                    W.id = y.ID + "-" + j, W.className = m + (a.cssAnimation ? " nx-with-animation" : ""), W.style.position = a.position, W.style.zIndex = a.zindex, W.style.background = a.backgroundColor, W.style.animationDuration = a.cssAnimationDuration + "ms", W.style.fontFamily = '"' + a.fontFamily + '", ' + s, W.style.display = "flex", W.style.flexWrap = "wrap", W.style.flexDirection = "column", W.style.alignItems = "center", W.style.justifyContent = "center", a.rtl && (W.setAttribute("dir", "rtl"), W.classList.add("nx-rtl-on")), W.innerHTML = M + P;
                    var X = t.getComputedStyle(R).getPropertyValue("position"), F = "string" == typeof X ? X.toLocaleLowerCase("en") : "relative", U = Math.round(1.25 * parseInt(a.svgSize)) + 40, Y = R.offsetHeight || 0, _ = "";
                    ...
                    if (V || 0 < _.length) {
                        ...
                        var J = '<style id="Style-' + y.ID + "-" + j + '">' + q + "." + v + "{" + $ + _ + "}</style>", Z = t.document.createRange();
            ...
            var o = setTimeout(function() {
                ...
                var i = e.getAttribute("id"), n = t.document.getElementById("Style-" + i);
                n && null !== n.parentNode && n.parentNode.removeChild(n), clearTimeout(o);
            }, a.cssAnimationDuration);
        }, G = function(t) {
            if (t && 0 < t.length) for(var e, o = 0; o < t.length; o++)(e = t[o]) && (e.classList.add("nx-remove"), Q(e));
            else "string" == typeof i ? b('"Notiflix.Block.remove();" function called with "' + i + '" selector, but this selector does not have a "Block" element to remove.') : b('"Notiflix.Block.remove();" function called with "' + i + '", but this "Array<HTMLElement>" or "NodeListOf<HTMLElement>" does not have a "Block" element to remove.');
        }, tt = function(t) {
            var e = setTimeout(function() {
                t.classList.remove(v), clearTimeout(e);
            }, a.cssAnimationDuration + 300);
        }, te = setTimeout(function() {
            for(var t, e = 0; e < h; e++)(t = L[e]) && (tt(t), G(B = t.querySelectorAll("[id^=" + y.ID + "]")));
            clearTimeout(te);
        }, l);
        a = k(!0, a, f);
    }, H = {
        ...
        Confirm: {
            ...
            merge: function(t) {
                return i ? void (i = k(!0, i, t)) : (x("You have to initialize the Confirm module before call Merge function."), !1);
            },
        ...
        Loading: {
            ...
            merge: function(t) {
                return n ? void (n = k(!0, n, t)) : (x("You have to initialize the Loading module before call Merge function."), !1);
            },
        ...
        Block: {
            ...
            merge: function(t) {
                return a ? void (a = k(!0, a, t)) : (x('You have to initialize the "Notiflix.Block" module before call Merge function.'), !1);
            },
...
const { toString: b } = Object.prototype, { getPrototypeOf: w } = Object, v = (o = Object.create(null), (t)=>{
    let e = b.call(t);
    return o[e] || (o[e] = e.slice(8, -1).toLowerCase());
}), k = (t)=>(t = t.toLowerCase(), (e)=>v(e) === t), C = (t)=>(e)=>typeof e === t, { isArray: N } = Array, S = C("undefined"), E = k("ArrayBuffer"), O = C("string"), I = C("function"), A = C("number"), L = (t)=>null !== t && "object" == typeof t, R = (t)=>{
    if ("object" !== v(t)) return !1;
    let e = w(t);
    return (null === e || e === Object.prototype || null === Object.getPrototypeOf(e)) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, T = k("Date"), z = k("File"), B = k("Blob"), D = k("FileList"), M = k("URLSearchParams");
function P(t, e, { allOwnKeys: o = !1 } = {}) {
    let i, n;
    if (null != t) {
        if ("object" != typeof t && (t = [
            t
        ]), N(t)) for(i = 0, n = t.length; i < n; i++)e.call(null, t[i], i, t);
        else {
            let n;
            let a = o ? Object.getOwnPropertyNames(t) : Object.keys(t), r = a.length;
...
"use strict";
const X = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : s, F = (t)=>!S(t) && t !== X, j = (i = "undefined" != typeof Uint8Array && w(Uint8Array), (t)=>i && t instanceof i), U = k("HTMLFormElement"), H = (({ hasOwnProperty: t })=>(e, o)=>t.call(e, o))(Object.prototype), Y = k("RegExp"), _ = (t, e)=>{
    let o = Object.getOwnPropertyDescriptors(t), i = {};
    P(o, (o, n)=>{
        !1 !== e(o, n, t) && (i[n] = o);
    }), Object.defineProperties(t, i);
}, q = "abcdefghijklmnopqrstuvwxyz", $ = "0123456789", V = {
    DIGIT: $,
    ALPHA: q,
...
var Z = {
    ...
    isArrayBuffer: E,
    isBuffer: function(t) {
        return null !== t && !S(t) && null !== t.constructor && !S(t.constructor) && I(t.constructor.isBuffer) && t.constructor.isBuffer(t);
    },
    isFormData: (t)=>{
        let e;
        return t && ("function" == typeof FormData && t instanceof FormData || I(t.append) && ("formdata" === (e = v(t)) || "object" === e && I(t.toString) && "[object FormData]" === t.toString()));
    },
    ...
    forEach: P,
    merge: function t() {
        let { caseless: e } = F(this) && this || {}, o = {}, i = (i, n)=>{
            let a = e && W(o, n) || n;
            R(o[a]) && R(i) ? o[a] = t(o[a], i) : R(i) ? o[a] = t({}, i) : N(i) ? o[a] = i.slice() : o[a] = i;
        };
        for(let t = 0, e = arguments.length; t < e; t++)arguments[t] && P(arguments[t], i);
        return o;
    },
    extend: (t, e, o, { allOwnKeys: i } = {})=>(P(e, (e, i)=>{
    ...
    toFlatObject: (t, e, o, i)=>{
        ...
        do {
            for(a = (n = Object.getOwnPropertyNames(t)).length; a-- > 0;)r = n[a], (!i || i(r, t, e)) && !s[r] && (e[r] = t[r], s[r] = !0);
            t = !1 !== o && w(t);
    ...
    forEachEntry: (t, e)=>{
        let o;
        let i = t && t[Symbol.iterator], n = i.call(t);
        for(; (o = n.next()) && !o.done;){
            let i = o.value;
            e.call(t, i[0], i[1]);
        }
    ...
    toObjectSet: (t, e)=>{
        ...
        })(N(t) ? t : String(t).split(e)), o;
    },
    toCamelCase: (t)=>t.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(t, e, o) {
    ...
    isSpecCompliantForm: function(t) {
        return !!(t && I(t.append) && "FormData" === t[Symbol.toStringTag] && t[Symbol.iterator]);
    },
    toJSONObject: (t)=>{
        let e = Array(10), o = (t, i)=>{
            if (L(t)) {
...
function K(t, e, o, i, n) {
    Error.call(this), Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : this.stack = Error().stack, this.message = t, this.name = "AxiosError", e && (this.code = e), o && (this.config = o), i && (this.request = i), n && (this.response = n);
}
Z.inherits(K, Error, {
    toJSON: function() {
        return {
...
}), Object.defineProperties(K, G), Object.defineProperty(Q, "isAxiosError", {
    value: !0
}), K.from = (t, e, o, i, n, a)=>{
    let r = Object.create(Q);
    return Z.toFlatObject(t, r, function(t) {
        return t !== Error.prototype;
    }, (t)=>"isAxiosError" !== t), K.call(r, t.message, e, o, i, n), r.cause = t, r.name = t.name, a && Object.assign(r, a), r;
}, n = function(t) {
    for(var e, o = t.length, i = o % 3, n = [], a = 0, r = o - i; a < r; a += 16383)n.push(function(t, e, o) {
        for(var i, n = [], a = e; a < o; a += 3)n.push(tt[(i = (t[a] << 16 & 16711680) + (t[a + 1] << 8 & 65280) + (255 & t[a + 2])) >> 18 & 63] + tt[i >> 12 & 63] + tt[i >> 6 & 63] + tt[63 & i]);
        return n.join("");
    }(t, a, a + 16383 > r ? r : a + 16383));
    return 1 === i ? n.push(tt[(e = t[o - 1]) >> 2] + tt[e << 4 & 63] + "==") : 2 === i && n.push(tt[(e = (t[o - 2] << 8) + t[o - 1]) >> 10] + tt[e >> 4 & 63] + tt[e << 2 & 63] + "="), n.join("");
};
for(var tt = [], te = [], to = "undefined" != typeof Uint8Array ? Uint8Array : Array, ti = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", tn = 0, ta = ti.length; tn < ta; ++tn)tt[tn] = ti[tn], te[ti.charCodeAt(tn)] = tn;
te["-".charCodeAt(0)] = 62, te["_".charCodeAt(0)] = 63, a = function(t, e, o, i, n) {
    var a, r, s = 8 * n - i - 1, l = (1 << s) - 1, c = l >> 1, f = -7, d = o ? n - 1 : 0, p = o ? -1 : 1, m = t[e + d];
    for(d += p, a = m & (1 << -f) - 1, m >>= -f, f += s; f > 0; a = 256 * a + t[e + d], d += p, f -= 8);
    for(r = a & (1 << -f) - 1, a >>= -f, f += i; f > 0; r = 256 * r + t[e + d], d += p, f -= 8);
    if (0 === a) a = 1 - c;
    else {
    ...
    var r, s, l, c = 8 * a - n - 1, f = (1 << c) - 1, d = f >> 1, p = 23 === n ? 5960464477539062e-23 : 0, m = i ? 0 : a - 1, u = i ? 1 : -1, h = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
    for(isNaN(e = Math.abs(e)) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, r = f) : (r = Math.floor(Math.log(e) / Math.LN2), e * (l = Math.pow(2, -r)) < 1 && (r--, l *= 2), r + d >= 1 ? e += p / l : e += p * Math.pow(2, 1 - d), e * l >= 2 && (r++, l /= 2), r + d >= f ? (s = 0, r = f) : r + d >= 1 ? (s = (e * l - 1) * Math.pow(2, n), r += d) : (s = e * Math.pow(2, d - 1) * Math.pow(2, n), r = 0)); n >= 8; t[o + m] = 255 & s, m += u, s /= 256, n -= 8);
    for(r = r << n | s, c += n; c > 0; t[o + m] = 255 & r, m += u, r /= 256, c -= 8);
    t[o + m - u] |= 128 * h;
};
const tr = "function" == typeof Symbol && "function" == typeof Symbol.for ? Symbol.for("nodejs.util.inspect.custom") : null;
function ts(t) {
...
function tc(t, e, o) {
    if ("string" == typeof t) return function(t, e) {
        if (("string" != typeof e || "" === e) && (e = "utf8"), !tl.isEncoding(e)) throw TypeError("Unknown encoding: " + e);
        let o = 0 | th(t, e), i = ts(o), n = i.write(t, e);
    ...
    if (tW(t, ArrayBuffer) || t && tW(t.buffer, ArrayBuffer) || "undefined" != typeof SharedArrayBuffer && (tW(t, SharedArrayBuffer) || t && tW(t.buffer, SharedArrayBuffer))) return tm(t, e, o);
    ...
    let n = function(t) {
        var e;
        if (tl.isBuffer(t)) {
            let e = 0 | tu(t.length), o = ts(e);
            return 0 === o.length || t.copy(o, 0, 0, e), o;
        }
        return void 0 !== t.length ? "number" != typeof t.length || (e = t.length) != e ? ts(0) : tp(t) : "Buffer" === t.type && Array.isArray(t.data) ? tp(t.data) : void 0;
    }(t);
    if (n) return n;
    if ("undefined" != typeof Symbol && null != Symbol.toPrimitive && "function" == typeof t[Symbol.toPrimitive]) return tl.from(t[Symbol.toPrimitive]("string"), e, o);
...
function tp(t) {
    let e = t.length < 0 ? 0 : 0 | tu(t.length), o = ts(e);
...
function tm(t, e, o) {
    ...
    return Object.setPrototypeOf(i = void 0 === e && void 0 === o ? new Uint8Array(t) : void 0 === o ? new Uint8Array(t, e) : new Uint8Array(t, e, o), tl.prototype), i;
}
function tu(t) {
...
function th(t, e) {
    ...
    let o = t.length, i = arguments.length > 2 && !0 === arguments[2];
    if (!i && 0 === o) return 0;
    let n = !1;
    for(;;)switch(e){
        case "ascii":
...
function tg(t, e, o) {
    ...
    for(t || (t = "utf8");;)switch(t){
        ...
        case "base64":
            var a, r;
            return a = e, r = o, 0 === a && r === this.length ? n(this) : n(this.slice(a, r));
        case "ucs2":
        case "ucs-2":
        case "utf16le":
        case "utf-16le":
...
function tx(t, e, o, i, n) {
    ...
    if ("string" == typeof o ? (i = o, o = 0) : o > 2147483647 ? o = 2147483647 : o < -2147483648 && (o = -2147483648), (a = o = +o) != a && (o = n ? 0 : t.length - 1), o < 0 && (o = t.length + o), o >= t.length) {
        if (n) return -1;
        o = t.length - 1;
    } else if (o < 0) {
        if (!n) return -1;
    ...
    if ("string" == typeof e && (e = tl.from(e, i)), tl.isBuffer(e)) return 0 === e.length ? -1 : tb(t, e, o, i, n);
    if ("number" == typeof e) return (e &= 255, "function" == typeof Uint8Array.prototype.indexOf) ? n ? Uint8Array.prototype.indexOf.call(t, e, o) : Uint8Array.prototype.lastIndexOf.call(t, e, o) : tb(t, [
        e
    ], o, i, n);
    throw TypeError("val must be string, number or Buffer");
}
function tb(t, e, o, i, n) {
    let a, r = 1, s = t.length, l = e.length;
    ...
    if (n) {
        let i = -1;
        for(a = o; a < s; a++)if (c(t, a) === c(e, -1 === i ? 0 : a - i)) {
            if (-1 === i && (i = a), a - i + 1 === l) return i * r;
        } else -1 !== i && (a -= a - i), i = -1;
    } else for(o + l > s && (o = s - l), a = o; a >= 0; a--){
        let o = !0;
        for(let i = 0; i < l; i++)if (c(t, a + i) !== c(e, i)) {
            o = !1;
            break;
        }
        if (o) return a;
...
function tw(t, e, o) {
    ...
    let i = [], n = e;
    for(; n < o;){
        let e = t[n], a = null, r = e > 239 ? 4 : e > 223 ? 3 : e > 191 ? 2 : 1;
        if (n + r <= o) {
            let o, i, s, l;
            switch(r){
                case 1:
                    ...
                    break;
                case 2:
                    (192 & (o = t[n + 1])) == 128 && (l = (31 & e) << 6 | 63 & o) > 127 && (a = l);
                    break;
                case 3:
                    o = t[n + 1], i = t[n + 2], (192 & o) == 128 && (192 & i) == 128 && (l = (15 & e) << 12 | (63 & o) << 6 | 63 & i) > 2047 && (l < 55296 || l > 57343) && (a = l);
                    break;
                case 4:
                    o = t[n + 1], i = t[n + 2], s = t[n + 3], (192 & o) == 128 && (192 & i) == 128 && (192 & s) == 128 && (l = (15 & e) << 18 | (63 & o) << 12 | (63 & i) << 6 | 63 & s) > 65535 && l < 1114112 && (a = l);
            }
        }
        null === a ? (a = 65533, r = 1) : a > 65535 && (a -= 65536, i.push(a >>> 10 & 1023 | 55296), a = 56320 | 1023 & a), i.push(a), n += r;
    }
    return function(t) {
        let e = t.length;
        if (e <= 4096) return String.fromCharCode.apply(String, t);
        let o = "", i = 0;
        for(; i < e;)o += String.fromCharCode.apply(String, t.slice(i, i += 4096));
        return o;
    }(i);
}
function tv(t, e, o) {
...
function tk(t, e, o, i, n, a) {
    if (!tl.isBuffer(t)) throw TypeError('"buffer" argument must be a Buffer instance');
...
function tC(t, e, o, i, n) {
    ...
    t[o++] = a, a >>= 8, t[o++] = a, a >>= 8, t[o++] = a, a >>= 8, t[o++] = a;
    let r = Number(e >> BigInt(32) & BigInt(4294967295));
    return t[o++] = r, r >>= 8, t[o++] = r, r >>= 8, t[o++] = r, r >>= 8, t[o++] = r, o;
}
function tN(t, e, o, i, n) {
    tR(e, i, n, t, o, 7);
    let a = Number(e & BigInt(4294967295));
    t[o + 7] = a, a >>= 8, t[o + 6] = a, a >>= 8, t[o + 5] = a, a >>= 8, t[o + 4] = a;
    let r = Number(e >> BigInt(32) & BigInt(4294967295));
    return t[o + 3] = r, r >>= 8, t[o + 2] = r, r >>= 8, t[o + 1] = r, r >>= 8, t[o] = r, o + 8;
}
function tS(t, e, o, i, n, a) {
    if (o + i > t.length || o < 0) throw RangeError("Index out of range");
}
function tE(t, e, o, i, n) {
    return e = +e, o >>>= 0, n || tS(t, e, o, 4, 34028234663852886e22, -340282346638528860000000000000000000000), r(t, e, o, i, 23, 4), o + 4;
}
function tO(t, e, o, i, n) {
    return e = +e, o >>>= 0, n || tS(t, e, o, 8, 17976931348623157e292, -), r(t, e, o, i, 52, 8), o + 8;
}
tl.TYPED_ARRAY_SUPPORT = function() {
...
}(), tl.TYPED_ARRAY_SUPPORT || "undefined" == typeof console || "function" != typeof console.error || console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."), Object.defineProperty(tl.prototype, "parent", {
    enumerable: !0,
    get: function() {
...
}), tl.poolSize = 8192, tl.from = function(t, e, o) {
    return tc(t, e, o);
}, Object.setPrototypeOf(tl.prototype, Uint8Array.prototype), Object.setPrototypeOf(tl, Uint8Array), tl.alloc = function(t, e, o) {
    return (tf(t), t <= 0) ? ts(t) : void 0 !== e ? "string" == typeof o ? ts(t).fill(e, o) : ts(t).fill(e) : ts(t);
    ...
    if (tW(t, Uint8Array) && (t = tl.from(t, t.offset, t.byteLength)), tW(e, Uint8Array) && (e = tl.from(e, e.offset, e.byteLength)), !tl.isBuffer(t) || !tl.isBuffer(e)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
    if (t === e) return 0;
    let o = t.length, i = e.length;
    for(let n = 0, a = Math.min(o, i); n < a; ++n)if (t[n] !== e[n]) {
        o = t[n], i = e[n];
        break;
    }
    ...
    let i = tl.allocUnsafe(e), n = 0;
    for(o = 0; o < t.length; ++o){
        let e = t[o];
        if (tW(e, Uint8Array)) n + e.length > i.length ? (tl.isBuffer(e) || (e = tl.from(e)), e.copy(i, n)) : Uint8Array.prototype.set.call(i, e, n);
        else if (tl.isBuffer(e)) e.copy(i, n);
        else throw TypeError('"list" argument must be an Array of Buffers');
        n += e.length;
    }
    return i;
}, tl.byteLength = th, tl.prototype._isBuffer = !0, tl.prototype.swap16 = function() {
    let t = this.length;
    ...
    for(let e = 0; e < t; e += 8)ty(this, e, e + 7), ty(this, e + 1, e + 6), ty(this, e + 2, e + 5), ty(this, e + 3, e + 4);
    return this;
}, tl.prototype.toString = function() {
    let t = this.length;
    return 0 === t ? "" : 0 == arguments.length ? tw(this, 0, t) : tg.apply(this, arguments);
}, tl.prototype.toLocaleString = tl.prototype.toString, tl.prototype.equals = function(t) {
...
}, tr && (tl.prototype[tr] = tl.prototype.inspect), tl.prototype.compare = function(t, e, o, i, n) {
    if (tW(t, Uint8Array) && (t = tl.from(t, t.offset, t.byteLength)), !tl.isBuffer(t)) throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t);
    if (void 0 === e && (e = 0), void 0 === o && (o = t ? t.length : 0), void 0 === i && (i = 0), void 0 === n && (n = this.length), e < 0 || o > t.length || i < 0 || n > this.length) throw RangeError("out of range index");
    if (i >= n && e >= o) return 0;
    if (i >= n) return -1;
    if (e >= o) return 1;
    if (e >>>= 0, o >>>= 0, i >>>= 0, n >>>= 0, this === t) return 0;
    let a = n - i, r = o - e, s = Math.min(a, r), l = this.slice(i, n), c = t.slice(e, o);
    for(let t = 0; t < s; ++t)if (l[t] !== c[t]) {
        a = l[t], r = c[t];
        break;
    }
    ...
    else if (void 0 === o && "string" == typeof e) i = e, o = this.length, e = 0;
    else if (isFinite(e)) e >>>= 0, isFinite(o) ? (o >>>= 0, void 0 === i && (i = "utf8")) : (i = o, o = void 0);
    else throw Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");
    let p = this.length - e;
    if ((void 0 === o || o > p) && (o = p), t.length > 0 && (o < 0 || e < 0) || e > this.length) throw RangeError("Attempt to write outside buffer bounds");
    i || (i = "utf8");
    let m = !1;
    for(;;)switch(i){
        case "hex":
        ...
        case "utf16le":
        case "utf-16le":
            return f = e, d = o, tP(function(t, e) {
                let o, i;
                let n = [];
                for(let a = 0; a < t.length && !((e -= 2) < 0); ++a)i = (o = t.charCodeAt(a)) >> 8, n.push(o % 256), n.push(i);
                return n;
...
}, tl.prototype.readUintLE = tl.prototype.readUIntLE = function(t, e, o) {
    t >>>= 0, e >>>= 0, o || tv(t, e, this.length);
    let i = this[t], n = 1, a = 0;
    for(; ++a < e && (n *= 256);)i += this[t + a] * n;
    return i;
}, tl.prototype.readUintBE = tl.prototype.readUIntBE = function(t, e, o) {
    t >>>= 0, e >>>= 0, o || tv(t, e, this.length);
    let i = this[t + --e], n = 1;
    for(; e > 0 && (n *= 256);)i += this[t + --e] * n;
    return i;
}, tl.prototype.readUint8 = tl.prototype.readUInt8 = function(t, e) {
    return t >>>= 0, e || tv(t, 1, this.length), this[t];
}, tl.prototype.readUint16LE = tl.prototype.readUInt16LE = function(t, e) {
    return t >>>= 0, e || tv(t, 2, this.length), this[t] | this[t + 1] << 8;
}, tl.prototype.readUint16BE = tl.prototype.readUInt16BE = function(t, e) {
    return t >>>= 0, e || tv(t, 2, this.length), this[t] << 8 | this[t + 1];
}, tl.prototype.readUint32LE = tl.prototype.readUInt32LE = function(t, e) {
    return t >>>= 0, e || tv(t, 4, this.length), (this[t] | this[t + 1] << 8 | this[t + 2] << 16) + 16777216 * this[t + 3];
}, tl.prototype.readUint32BE = tl.prototype.readUInt32BE = function(t, e) {
    return t >>>= 0, e || tv(t, 4, this.length), 16777216 * this[t] + (this[t + 1] << 16 | this[t + 2] << 8 | this[t + 3]);
}, tl.prototype.readBigUInt64LE = tF(function(t) {
    tT(t >>>= 0, "offset");
    let e = this[t], o = this[t + 7];
    (void 0 === e || void 0 === o) && tz(t, this.length - 8);
    let i = e + 256 * this[++t] + 65536 * this[++t] + 16777216 * this[++t], n = this[++t] + 256 * this[++t] + 65536 * this[++t] + 16777216 * o;
    return BigInt(i) + (BigInt(n) << BigInt(32));
}), tl.prototype.readBigUInt64BE = tF(function(t) {
    tT(t >>>= 0, "offset");
    let e = this[t], o = this[t + 7];
    (void 0 === e || void 0 === o) && tz(t, this.length - 8);
    let i = 16777216 * e + 65536 * this[++t] + 256 * this[++t] + this[++t], n = 16777216 * this[++t] + 65536 * this[++t] + 256 * this[++t] + o;
    ...
    return t >>>= 0, e || tv(t, 4, this.length), this[t] | this[t + 1] << 8 | this[t + 2] << 16 | this[t + 3] << 24;
}, tl.prototype.readInt32BE = function(t, e) {
    return t >>>= 0, e || tv(t, 4, this.length), this[t] << 24 | this[t + 1] << 16 | this[t + 2] << 8 | this[t + 3];
    ...
    return (BigInt(i) << BigInt(32)) + BigInt(16777216 * this[++t] + 65536 * this[++t] + 256 * this[++t] + o);
...
}, tl.prototype.writeUintLE = tl.prototype.writeUIntLE = function(t, e, o, i) {
    if (t = +t, e >>>= 0, o >>>= 0, !i) {
    ...
    return e + o;
}, tl.prototype.writeUintBE = tl.prototype.writeUIntBE = function(t, e, o, i) {
    if (t = +t, e >>>= 0, o >>>= 0, !i) {
        let i = Math.pow(2, 8 * o) - 1;
        tk(this, t, e, o, i, 0);
    }
    ...
    return e + o;
}, tl.prototype.writeUint8 = tl.prototype.writeUInt8 = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 1, 255, 0), this[e] = 255 & t, e + 1;
}, tl.prototype.writeUint16LE = tl.prototype.writeUInt16LE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 2, 65535, 0), this[e] = 255 & t, this[e + 1] = t >>> 8, e + 2;
}, tl.prototype.writeUint16BE = tl.prototype.writeUInt16BE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 2, 65535, 0), this[e] = t >>> 8, this[e + 1] = 255 & t, e + 2;
}, tl.prototype.writeUint32LE = tl.prototype.writeUInt32LE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 4, 4294967295, 0), this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t, e + 4;
}, tl.prototype.writeUint32BE = tl.prototype.writeUInt32BE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 4, 4294967295, 0), this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t, e + 4;
    ...
    let n = 0, a = 1, r = 0;
    for(this[e] = 255 & t; ++n < o && (a *= 256);)t < 0 && 0 === r && 0 !== this[e + n - 1] && (r = 1), this[e + n] = (t / a >> 0) - r & 255;
    return e + o;
    ...
    let n = o - 1, a = 1, r = 0;
    for(this[e + n] = 255 & t; --n >= 0 && (a *= 256);)t < 0 && 0 === r && 0 !== this[e + n + 1] && (r = 1), this[e + n] = (t / a >> 0) - r & 255;
    return e + o;
}, tl.prototype.writeInt8 = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 1, 127, -128), t < 0 && (t = 255 + t + 1), this[e] = 255 & t, e + 1;
}, tl.prototype.writeInt16LE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 2, 32767, -32768), this[e] = 255 & t, this[e + 1] = t >>> 8, e + 2;
}, tl.prototype.writeInt16BE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 2, 32767, -32768), this[e] = t >>> 8, this[e + 1] = 255 & t, e + 2;
}, tl.prototype.writeInt32LE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 4, 2147483647, -2147483648), this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24, e + 4;
}, tl.prototype.writeInt32BE = function(t, e, o) {
    return t = +t, e >>>= 0, o || tk(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t, e + 4;
}, tl.prototype.writeBigInt64LE = tF(function(t, e = 0) {
    return tC(this, t, e, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
}), tl.prototype.writeBigInt64BE = tF(function(t, e = 0) {
    return tN(this, t, e, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
    ...
    if (o || (o = 0), i || 0 === i || (i = this.length), e >= t.length && (e = t.length), e || (e = 0), i > 0 && i < o && (i = o), i === o || 0 === t.length || 0 === this.length) return 0;
    ...
    let n = i - o;
    return this === t && "function" == typeof Uint8Array.prototype.copyWithin ? this.copyWithin(e, o, i) : Uint8Array.prototype.set.call(t, this.subarray(o, i), e), n;
}, tl.prototype.fill = function(t, e, o, i) {
    let n;
    if ("string" == typeof t) {
        if ("string" == typeof e ? (i = e, e = 0, o = this.length) : "string" == typeof o && (i = o, o = this.length), void 0 !== i && "string" != typeof i) throw TypeError("encoding must be a string");
        if ("string" == typeof i && !tl.isEncoding(i)) throw TypeError("Unknown encoding: " + i);
        if (1 === t.length) {
    ...
    if (o <= e) return this;
    if (e >>>= 0, o = void 0 === o ? this.length : o >>> 0, t || (t = 0), "number" == typeof t) for(n = e; n < o; ++n)this[n] = t;
    else {
        let a = tl.isBuffer(t) ? t : tl.from(t, i), r = a.length;
        if (0 === r) throw TypeError('The value "' + t + '" is invalid for argument "value"');
...
function tR(t, e, o, i, n, a) {
    if (t > o || t < e) {
        ...
        throw i = a > 3 ? 0 === e || e === BigInt(0) ? `>= 0${n} and < 2${n} ** ${(a + 1) * 8}${n}` : `>= -(2${n} ** ${(a + 1) * 8 - 1}${n}) and < 2 ** ${(a + 1) * 8 - 1}${n}` : `>= ${e}${n} and <= ${o}${n}`, new tI.ERR_OUT_OF_RANGE("value", i, t);
    }
    tT(n, "offset"), (void 0 === i[n] || void 0 === i[n + a]) && tz(n, i.length - (a + 1));
}
function tT(t, e) {
    if ("number" != typeof t) throw new tI.ERR_INVALID_ARG_TYPE(e, "number", t);
}
function tz(t, e, o) {
    if (Math.floor(t) !== t) throw tT(t, o), new tI.ERR_OUT_OF_RANGE(o || "offset", "an integer", t);
    if (e < 0) throw new tI.ERR_BUFFER_OUT_OF_BOUNDS();
    throw new tI.ERR_OUT_OF_RANGE(o || "offset", `>= ${o ? 1 : 0} and <= ${e}`, t);
}
tA("ERR_BUFFER_OUT_OF_BOUNDS", function(t) {
    return t ? `${t} is outside of buffer bounds` : "Attempt to access memory outside buffer bounds";
}, RangeError), tA("ERR_INVALID_ARG_TYPE", function(t, e) {
    return `The "${t}" argument must be of type number. Received type ${typeof e}`;
}, TypeError), tA("ERR_OUT_OF_RANGE", function(t, e, o) {
    let i = `The value of "${t}" is out of range.`, n = o;
    return Number.isInteger(o) && Math.abs(o) > 4294967296 ? n = tL(String(o)) : "bigint" == typeof o && (n = String(o), (o > BigInt(2) ** BigInt(32) || o < -(BigInt(2) ** BigInt(32))) && (n = tL(n)), n += "n"), i += ` It must be ${e}. Received ${n}`;
}, RangeError);
const tB = /[^+/0-9A-Za-z-_]/g;
function tD(t, e) {
    let o;
    e = e || 1 / 0;
    let i = t.length, n = null, a = [];
    for(let r = 0; r < i; ++r){
...
function tM(t) {
    return function(t) {
        ...
        }(t), n = i[0], a = i[1], r = new to((n + a) * 3 / 4 - a), s = 0, l = a > 0 ? n - 4 : n;
        for(o = 0; o < l; o += 4)e = te[t.charCodeAt(o)] << 18 | te[t.charCodeAt(o + 1)] << 12 | te[t.charCodeAt(o + 2)] << 6 | te[t.charCodeAt(o + 3)], r[s++] = e >> 16 & 255, r[s++] = e >> 8 & 255, r[s++] = 255 & e;
        return 2 === a && (e = te[t.charCodeAt(o)] << 2 | te[t.charCodeAt(o + 1)] >> 4, r[s++] = 255 & e), 1 === a && (e = te[t.charCodeAt(o)] << 10 | te[t.charCodeAt(o + 1)] << 4 | te[t.charCodeAt(o + 2)] >> 2, r[s++] = e >> 8 & 255, r[s++] = 255 & e), r;
    }(function(t) {
        if ((t = (t = t.split("=")[0]).trim().replace(tB, "")).length < 2) return "";
        for(; t.length % 4 != 0;)t += "=";
        return t;
    }(t));
}
function tP(t, e, o, i) {
    let n;
    for(n = 0; n < i && !(n + o >= e.length) && !(n >= t.length); ++n)e[n + o] = t[n];
    return n;
}
function tW(t, e) {
...
const tX = function() {
    let t = "0123456789abcdef", e = Array(256);
    for(let o = 0; o < 16; ++o){
        let i = 16 * o;
...
var tq = function(t, e, o) {
    ...
    e = e || new FormData(), o = Z.toFlatObject(o, {
        metaTokens: !0,
        dots: !1,
        indexes: !1
    }, !1, function(t, e) {
    ...
    let i = o.metaTokens, n = o.visitor || f, a = o.dots, r = o.indexes, s = o.Blob || "undefined" != typeof Blob && Blob, l = s && Z.isSpecCompliantForm(e);
    if (!Z.isFunction(n)) throw TypeError("visitor must be a function");
    function c(t) {
        if (null === t) return "";
        if (Z.isDate(t)) return t.toISOString();
        if (!l && Z.isBlob(t)) throw new K("Blob is not supported. Use a Buffer instead.");
        return Z.isArrayBuffer(t) || Z.isTypedArray(t) ? l && "function" == typeof Blob ? new Blob([
            t
        ]) : tl.from(t) : t;
    }
    function f(t, o, n) {
        ...
        if (t && !n && "object" == typeof t) {
            if (Z.endsWith(o, "{}")) o = i ? o : o.slice(0, -2), t = JSON.stringify(t);
            else {
                var l;
                if (Z.isArray(t) && (l = t, Z.isArray(l) && !l.some(tU)) || (Z.isFileList(t) || Z.endsWith(o, "[]")) && (s = Z.toArray(t))) return o = tH(o), s.forEach(function(t, i) {
                    Z.isUndefined(t) || null === t || e.append(!0 === r ? tY([
                        o
                    ], i, a) : null === r ? o : o + "[]", c(t));
                }), !1;
            }
    ...
    return !function t(o, i) {
        if (!Z.isUndefined(o)) {
            if (-1 !== d.indexOf(o)) throw Error("Circular reference detected in " + i.join("."));
            d.push(o), Z.forEach(o, function(o, a) {
                let r = !(Z.isUndefined(o) || null === o) && n.call(e, o, Z.isString(a) ? a.trim() : a, i, p);
                !0 === r && t(o, i ? i.concat(a) : [
                    a
                ]);
            }), d.pop();
        }
...
function tK(t, e, o) {
    let i;
    if (!e) return t;
    let n = o && o.encode || tZ, a = o && o.serialize;
    if (i = a ? a(e, o) : Z.isURLSearchParams(e) ? e.toString() : new tV(e, o).toString(n)) {
        let e = t.indexOf("#");
...
}, t0 = "undefined" != typeof URLSearchParams ? URLSearchParams : tV, t1 = "undefined" != typeof FormData ? FormData : null, t2 = "undefined" != typeof Blob ? Blob : null;
"use strict";
const t6 = (()=>{
    let t;
...
})(), t5 = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && "function" == typeof self.importScripts;
"use strict";
"use strict";
var t3 = {
    isBrowser: !0,
    ...
    if (Z.isFormData(t) && Z.isFunction(t.entries)) {
        let e = {};
        return Z.forEachEntry(t, (t, o)=>{
            !function t(e, o, i, n) {
                let a = e[n++], r = Number.isFinite(+a), s = n >= e.length;
                if (a = !a && Z.isArray(i) ? i.length : a, s) return Z.hasOwnProp(i, a) ? i[a] = [
                    i[a],
                    o
                ] : i[a] = o, !r;
                i[a] && Z.isObject(i[a]) || (i[a] = []);
                let l = t(e, o, i[a], n);
                return l && Z.isArray(i[a]) && (i[a] = function(t) {
                    let e, o;
                    let i = {}, n = Object.keys(t), a = n.length;
                    for(e = 0; e < a; e++)i[o = n[e]] = t[o];
                    return i;
                }(i[a])), !r;
            }(Z.matchAll(/\w+|\[(\w*)]/g, t).map((t)=>"[]" === t[0] ? "" : t[1] || t[0]), o, e, 0);
        }), e;
    }
    return null;
};
...
const t8 = {
    ...
    transformRequest: [
        function(t, e) {
            let o;
            let i = e.getContentType() || "", n = i.indexOf("application/json") > -1, a = Z.isObject(t);
            ...
            if (a) {
                if (i.indexOf("application/x-www-form-urlencoded") > -1) {
                    var s, l;
                    return (s = t, l = this.formSerializer, tq(s, new t3.classes.URLSearchParams(), Object.assign({
                        visitor: function(t, e, o, i) {
                            return t3.isNode && Z.isBuffer(t) ? (this.append(e, t.toString("base64")), !1) : i.defaultVisitor.apply(this, arguments);
                        }
                    }, l))).toString();
                }
            ...
            return a || n ? (e.setContentType("application/json", !1), function(t, e, o) {
                if (Z.isString(t)) try {
    ...
    transformResponse: [
        function(t) {
            let e = this.transitional || t9.transitional, o = e && e.forcedJSONParsing, i = "json" === this.responseType;
    ...
    maxBodyLength: -1,
    env: {
        FormData: t3.classes.FormData,
        Blob: t3.classes.Blob
    },
...
var et = (t)=>{
    ...
    let n = {};
    return t && t.split("\n").forEach(function(t) {
        i = t.indexOf(":"), e = t.substring(0, i).trim().toLowerCase(), o = t.substring(i + 1).trim(), !e || n[e] && t7[e] || ("set-cookie" === e ? n[e] ? n[e].push(o) : n[e] = [
            o
        ] : n[e] = n[e] ? n[e] + ", " + o : o);
    }), n;
};
...
class er {
    set(t, e, o) {
        ...
        function n(t, e, o) {
            ...
            let a = Z.findKey(i, n);
            a && void 0 !== i[a] && !0 !== o && (void 0 !== o || !1 === i[a]) || (i[a || e] = ei(t));
        }
        let a = (t, e)=>Z.forEach(t, (t, o)=>n(t, o, e));
        return Z.isPlainObject(t) || t instanceof this.constructor ? a(t, e) : Z.isString(t) && (t = t.trim()) && !en(t) ? a(et(t), e) : null != t && n(e, t, o), this;
    }
    get(t, e) {
        if (t = eo(t)) {
            ...
            if (o) {
                ...
                if (!0 === e) return function(t) {
                    let e;
                    let o = Object.create(null), i = /([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;
    ...
    clear(t) {
        let e = Object.keys(this), o = e.length, i = !1;
        for(; o--;){
            let n = e[o];
    ...
    normalize(t) {
        ...
        return Z.forEach(this, (i, n)=>{
            ...
            let r = t ? n.trim().toLowerCase().replace(/([a-z\d])(\w*)/g, (t, e, o)=>e.toUpperCase() + o) : String(n).trim();
    ...
    static accessor(t) {
        let e = this[ee] = this[ee] = {
            accessors: {}
        }, o = e.accessors, i = this.prototype;
        function n(t) {
            let e = eo(t);
            o[e] || (!function(t, e) {
...
"use strict";
function es(t, e) {
    let o = this || t9, i = e || o, n = er.from(i.headers), a = i.data;
...
"use strict";
function ec(t, e, o) {
    K.call(this, null == t ? "canceled" : t, K.ERR_CANCELED, e, o), this.name = "CanceledError";
}
"use strict";
er.accessor([
    "Content-Type",
    ...
    "User-Agent",
    "Authorization"
]), Z.freezeMethods(er.prototype), Z.freezeMethods(er), Z.inherits(ec, K, {
    __CANCEL__: !0
});
"use strict";
"use strict";
...
var ef = t3.isStandardBrowserEnv ? {
    write: function(t, e, o, i, n, a) {
        let r = [];
        r.push(t + "=" + encodeURIComponent(e)), Z.isNumber(o) && r.push("expires=" + new Date(o).toGMTString()), Z.isString(i) && r.push("path=" + i), Z.isString(n) && r.push("domain=" + n), !0 === a && r.push("secure"), document.cookie = r.join("; ");
    },
    read: function(t) {
...
"use strict";
"use strict";
var ep = t3.isStandardBrowserEnv ? function() {
    let t;
    let e = /(msie|trident)/i.test(navigator.userAgent), o = document.createElement("a");
    function i(t) {
        let i = t;
        return e && (o.setAttribute("href", i), i = o.href), o.setAttribute("href", i), {
            href: o.href,
    ...
    let o;
    t = t || 10;
    let i = Array(t), n = Array(t), a = 0, r = 0;
    return e = void 0 !== e ? e : 1e3, function(s) {
        let l = Date.now(), c = n[r];
        o || (o = l), i[a] = s, n[a] = l;
        let f = r, d = 0;
        for(; f !== a;)d += i[f++], f %= t;
...
function eu(t, e) {
    let o = 0, i = em(50, 250);
    return (n)=>{
        let a = n.loaded, r = n.lengthComputable ? n.total : void 0, s = a - o, l = i(s), c = a <= r;
        o = a;
        let f = {
            loaded: a,
            total: r,
...
var eg = eh && function(t) {
    return new Promise(function(e, o) {
        let i, n = t.data, a = er.from(t.headers).normalize(), r = t.responseType;
        function s() {
            t.cancelToken && t.cancelToken.unsubscribe(i), t.signal && t.signal.removeEventListener("abort", i);
        }
        Z.isFormData(n) && (t3.isStandardBrowserEnv || t3.isStandardBrowserWebWorkerEnv ? a.setContentType(!1) : a.setContentType("multipart/form-data;", !1));
        let l = new XMLHttpRequest();
        if (t.auth) {
            let e = t.auth.username || "", o = t.auth.password ? unescape(encodeURIComponent(t.auth.password)) : "";
            a.set("Authorization", "Basic " + btoa(e + ":" + o));
        }
        let c = ed(t.baseURL, t.url);
        function f() {
            if (!l) return;
            let i = er.from("getAllResponseHeaders" in l && l.getAllResponseHeaders()), n = r && "text" !== r && "json" !== r ? l.response : l.responseText, a = {
                data: n,
                status: l.status,
            ...
            (function(t, e, o) {
                ...
                !o.status || !i || i(o.status) ? t(o) : e(new K("Request failed with status code " + o.status, [
                    K.ERR_BAD_REQUEST,
                    K.ERR_BAD_RESPONSE
        ...
        if (l.open(t.method.toUpperCase(), tK(c, t.params, t.paramsSerializer), !0), l.timeout = t.timeout, "onloadend" in l ? l.onloadend = f : l.onreadystatechange = function() {
            ...
            let e = t.timeout ? "timeout of " + t.timeout + "ms exceeded" : "timeout exceeded", i = t.transitional || tG;
            t.timeoutErrorMessage && (e = t.timeoutErrorMessage), o(new K(e, i.clarifyTimeoutError ? K.ETIMEDOUT : K.ECONNABORTED, t, l)), l = null;
        }, t3.isStandardBrowserEnv) {
            let e = (t.withCredentials || ep(c)) && t.xsrfCookieName && ef.read(t.xsrfCookieName);
            e && a.set(t.xsrfHeaderName, e);
        }
        void 0 === n && a.setContentType(null), "setRequestHeader" in l && Z.forEach(a.toJSON(), function(t, e) {
            l.setRequestHeader(e, t);
        }), Z.isUndefined(t.withCredentials) || (l.withCredentials = !!t.withCredentials), r && "json" !== r && (l.responseType = t.responseType), "function" == typeof t.onDownloadProgress && l.addEventListener("progress", eu(t.onDownloadProgress, !0)), "function" == typeof t.onUploadProgress && l.upload && l.upload.addEventListener("progress", eu(t.onUploadProgress)), (t.cancelToken || t.signal) && (i = (e)=>{
            l && (o(!e || e.type ? new ec(null, t, l) : e), l.abort(), l = null);
...
var ex = {
    getAdapter: (t)=>{
        ...
        let { length: i } = t;
        for(let n = 0; n < i && (e = t[n], !(o = Z.isString(e) ? ey[e.toLowerCase()] : e)); n++);
        if (!o) {
            if (!1 === o) throw new K(`Adapter ${e} is not supported by the environment`, "ERR_NOT_SUPPORT");
            throw Error(Z.hasOwnProp(ey, e) ? `Adapter '${e}' is not available in the build` : `Unknown adapter '${e}'`);
        }
...
function eb(t) {
    if (t.cancelToken && t.cancelToken.throwIfRequested(), t.signal && t.signal.aborted) throw new ec(null, t);
}
function ew(t) {
    eb(t), t.headers = er.from(t.headers), t.data = es.call(t, t.transformRequest), -1 !== [
        "post",
        "put",
        "patch"
    ].indexOf(t.method) && t.headers.setContentType("application/x-www-form-urlencoded", !1);
    let e = ex.getAdapter(t.adapter || t9.adapter);
    return e(t).then(function(e) {
        return eb(t), e.data = es.call(t, t.transformResponse, e), e.headers = er.from(e.headers), e;
    }, function(e) {
        return !el(e) && (eb(t), e && e.response && (e.response.data = es.call(t, t.transformResponse, e.response), e.response.headers = er.from(e.response.headers))), Promise.reject(e);
    });
}
"use strict";
...
function ek(t, e) {
    ...
    function n(t, e, o) {
        return Z.isUndefined(e) ? Z.isUndefined(t) ? void 0 : i(void 0, t, o) : i(t, e, o);
    }
    function a(t, e) {
        if (!Z.isUndefined(e)) return i(void 0, e);
    }
    function r(t, e) {
        return Z.isUndefined(e) ? Z.isUndefined(t) ? void 0 : i(void 0, t) : i(void 0, e);
    }
    function s(o, n, a) {
    ...
    return Z.forEach(Object.keys(Object.assign({}, t, e)), function(i) {
        let a = l[i] || n, r = a(t[i], e[i], i);
...
eN.transitional = function(t, e, o) {
    function i(t, e) {
        return "[Axios v" + eC + "] Transitional option '" + t + "'" + e + (o ? ". " + o : "");
    }
    return (o, n, a)=>{
        if (!1 === t) throw new K(i(n, " has been removed" + (e ? " in " + e : "")), K.ERR_DEPRECATED);
        return e && !eS[n] && (eS[n] = !0, console.warn(i(n, " has been deprecated since v" + e + " and will be removed in the near future"))), !t || t(o, n, a);
    };
};
var eE = {
    assertOptions: function(t, e, o) {
        ...
        for(; n-- > 0;){
            let a = i[n], r = e[a];
            if (r) {
                let e = t[a], o = void 0 === e || r(e, a, t);
                if (!0 !== o) throw new K("option " + a + " must be " + o, K.ERR_BAD_OPTION_VALUE);
                continue;
            }
...
class eI {
    request(t, e) {
        let o, i, n;
        "string" == typeof t ? (e = e || {}).url = t : e = t || {}, e = ek(this.defaults, e);
        let { transitional: a, paramsSerializer: r, headers: s } = e;
        void 0 !== a && eE.assertOptions(a, {
        ...
        }, !0)), e.method = (e.method || this.defaults.method || "get").toLowerCase(), (o = s && Z.merge(s.common, s[e.method])) && Z.forEach([
            "delete",
            "get",
            "head",
            "post",
        ...
        if (!c) {
            ...
            for(t.unshift.apply(t, l), t.push.apply(t, f), n = t.length, i = Promise.resolve(e); d < n;)i = i.then(t[d++], t[d++]);
            return i;
        }
        n = l.length;
        let p = e;
...
const eR = function t(e) {
    let o = new eI(e), i = x(eI.prototype.request, o);
    return Z.extend(i, eI.prototype, o, {
        allOwnKeys: !0
    }), Z.extend(i, o, null, {
        allOwnKeys: !0
    }), i.create = function(o) {
...
eR.Axios = eI, eR.CanceledError = ec, eR.CancelToken = eA, eR.isCancel = el, eR.VERSION = eC, eR.toFormData = tq, eR.AxiosError = K, eR.Cancel = eR.CanceledError, eR.all = function(t) {
...
}, eR.mergeConfig = ek, eR.AxiosHeaders = er, eR.formToJSON = (t)=>t4(Z.isHTMLForm(t) ? new FormData(t) : t), eR.HttpStatusCode = eL, eR.default = eR;
const { Axios: eT, AxiosError: ez, CanceledError: eB, isCancel: eD, CancelToken: eM, VERSION: eP, all: eW, Cancel: eX, isAxiosError: eF, spread: ej, toFormData: eU, AxiosHeaders: eH, HttpStatusCode: eY, formToJSON: e_, mergeConfig: eq } = eR;
async function e$(t, e, o) {
    try {
        let i = await eR.get(`https://pixabay.com/api/?key=37512295-7e92ae3b8c2d51cd4aec1f8a1&q=${t}&image_type=photo&orientation=horizontal&safesearch=true&page=${e}&per_page=${o}`);
        return i;
    } catch (t) {
        throw Error(t);
    }
}
const eV = document.querySelector(".search-form"), eJ = eV[0], eZ = document.querySelector(".load-more"), eK = document.querySelector(".gallery");
...
function eG({ webformatURL: t, largeImageURL: e, tags: o, likes: i, views: n, comments: a, downloads: r }) {
    return `
...
eV.addEventListener("submit", (e)=>{
    e.preventDefault(), "" !== eJ.value.trim() && (t = 1, eK.innerHTML = " ", e$(eJ.value, t, 40).then((t)=>{
        let e = t.data;
        if (0 === e.total) {
    ...
    t += 1, e$(eJ.value, t, 40).then((t)=>{
        console.log(t);
        let e = t.data;
        e.hits.length < 40 && (y("We're sorry, but you've reached the end of search results."), eZ.classList.add("is-hidden"));
        let o = e.hits.map((t)=>eG(t));
        eK.insertAdjacentHTML("beforeend", o.join("")), eQ.refresh();
    }).catch(()=>{
        y("We're sorry, but you've reached the end of search results."), eZ.classList.add("is-hidden");
    });
});
